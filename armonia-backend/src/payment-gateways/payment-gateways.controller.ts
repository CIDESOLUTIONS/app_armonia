...
export class PaymentGatewaysController {
  ...
  @ApiResponse({ status: 201, description: 'The payment gateway has been successfully created.' })
  ...
  @ApiResponse({ status: 200, description: 'Return all payment gateway configurations.' })
  @ApiBearerAuth()
  findAll(@Req() req) {
    const schemaName = req.user.schemaName;
  ...
  @ApiResponse({ status: 200, description: 'Return the payment gateway configuration.' })
  ...
  @ApiResponse({ status: 200, description: 'The payment gateway has been successfully updated.' })
  @ApiResponse({ status: 404, description: 'Payment gateway not found.' })
  @ApiBearerAuth()
  update(
    @Req() req,
  ...
  @ApiResponse({ status: 200, description: 'The payment gateway has been successfully deleted.' })
  @ApiResponse({ status: 404, description: 'Payment gateway not found.' })
  @ApiBearerAuth()
