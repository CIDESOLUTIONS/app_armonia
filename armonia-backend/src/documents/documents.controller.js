...
var DocumentsController = function () {
    ...
    var _getDocumentById_decorators;
    ...
    var DocumentsController = _classThis = /** @class */ (function () {
        ...
        DocumentsController_1.prototype.uploadDocument = function (user, file, createDocumentDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.documentsService.uploadDocument(user.schemaName, user.userId, file, createDocumentDto)];
                });
            });
        };
        DocumentsController_1.prototype.getDocuments = function (user, filters) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.documentsService.getDocuments(user.schemaName, filters)];
                });
            });
        };
        DocumentsController_1.prototype.getDocumentById = function (user, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.documentsService.getDocumentById(user.schemaName, +id)];
                });
            });
        };
        DocumentsController_1.prototype.deleteDocument = function (user, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.documentsService.deleteDocument(user.schemaName, +id)];
                });
            });
        };
    ...
    (function () {
        ...
        _getDocumentById_decorators = [(0, common_1.Get)(':id')];
        ...
        __esDecorate(_classThis, null, _getDocumentById_decorators, { kind: "method", name: "getDocumentById", static: false, private: false, access: { has: function (obj) { return "getDocumentById" in obj; }, get: function (obj) { return obj.getDocumentById; } }, metadata: _metadata }, null, _instanceExtraInitializers);
