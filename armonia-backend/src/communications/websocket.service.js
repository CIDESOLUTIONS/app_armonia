...
var WebSocketService = function () {
    var _classDecorators = [(0, common_1.Injectable)(), (0, websockets_1.WebSocketGateway)({ cors: { origin: '*' } })];
    ...
    var WebSocketService = _classThis = /** @class */ (function () {
        ...
        WebSocketService_1.prototype.sendToClient = function (clientId, event, data) {
            this.server.to(clientId).emit(event, data);
        };
        WebSocketService_1.prototype.sendToAll = function (event, data) {
