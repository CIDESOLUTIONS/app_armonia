...
var prisma_client_manager_1 = require("./prisma-client-manager");
var PrismaModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            providers: [prisma_service_1.PrismaService, prisma_client_manager_1.PrismaClientManager],
            exports: [prisma_service_1.PrismaService, prisma_client_manager_1.PrismaClientManager],
        })];
