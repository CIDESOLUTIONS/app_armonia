...
var UserController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, (0, roles_guard_1.RolesGuard)([user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.COMPLEX_ADMIN])), (0, common_1.Controller)('users')];
    ...
    var UserController = _classThis = /** @class */ (function () {
        ...
        UserController_1.prototype.createUser = function (user, userData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.createUser(user.schemaName, userData)];
                });
            });
        };
        UserController_1.prototype.findAllUsers = function (user, role) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.findAllUsers(user.schemaName, role)];
                });
            });
        };
        UserController_1.prototype.updateUser = function (user, id, userData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userService.updateUser(user.schemaName, +id, userData)];
                });
            });
        };
        UserController_1.prototype.deleteUser = function (user, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
    ...
    (function () {
        ...
        _getProfile_decorators = [(0, common_1.Get)('profile'), (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.COMPLEX_ADMIN, user_role_enum_1.UserRole.RESIDENT, user_role_enum_1.UserRole.STAFF, user_role_enum_1.UserRole.RECEPTION, user_role_enum_1.UserRole.SECURITY, user_role_enum_1.UserRole.CONCIERGE)];
        _createUser_decorators = [(0, common_1.Post)(), (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.COMPLEX_ADMIN)];
        _findAllUsers_decorators = [(0, common_1.Get)(), (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.COMPLEX_ADMIN)];
        _updateUser_decorators = [(0, common_1.Put)(':id'), (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.COMPLEX_ADMIN)];
        _deleteUser_decorators = [(0, common_1.Delete)(':id'), (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.COMPLEX_ADMIN)];
