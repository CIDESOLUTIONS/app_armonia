...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        function UserService_1(prisma, prismaClientManager) {
            this.prisma = prisma;
            this.prismaClientManager = prismaClientManager;
        }
        UserService_1.prototype.getTenantPrismaClient = function (schemaName) {
        ...
        UserService_1.prototype.createUser = function (schemaName, data) {
            return __awaiter(this, void 0, void 0, function () {
                var prisma, hashedPassword;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        UserService_1.prototype.findAllUsers = function (schemaName, role) {
            return __awaiter(this, void 0, void 0, function () {
                var prisma, where;
                return __generator(this, function (_a) {
                    prisma = this.getTenantPrismaClient(schemaName);
                    ...
                    return [2 /*return*/, prisma.user.findMany({ where: where })];
                });
            });
        };
        UserService_1.prototype.updateUser = function (schemaName, id, data) {
            return __awaiter(this, void 0, void 0, function () {
                var prisma, user, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            _a.password = _b.sent();
                            _b.label = 3;
                        case 3: return [2 /*return*/, prisma.user.update({ where: { id: id }, data: data })];
                    }
                });
            });
        };
        UserService_1.prototype.deleteUser = function (schemaName, id) {
            return __awaiter(this, void 0, void 0, function () {
                var prisma, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
