...
const fineFormSchema = z.object({
  ...
  unitId: z.preprocess(
    ...
    z
      .number()
      .int()
      .positive("La unidad debe ser un número entero positivo.")
      .optional(),
  ),
  residentId: z.preprocess(
    ...
    z
      .number()
      .int()
      .positive("El residente debe ser un número entero positivo.")
      .optional(),
  ),
});
      ...
      <CardContent>
        ...
        <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle>
                {isEditing ? "Editar Multa" : "Añadir Nueva Multa"}
              </DialogTitle>
              <DialogDescription>
                {isEditing
                  ? "Modifica los detalles de la multa."
                  : "Crea una nueva multa para una unidad o residente."}
              </DialogDescription>
            </DialogHeader>
            <form
