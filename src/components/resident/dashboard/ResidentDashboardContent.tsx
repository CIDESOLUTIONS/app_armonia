    ...
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Gestione sus servicios y manténgase al día con su comunidad
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link
            ...
            className="bg-white p-4 rounded-xl border border-gray-200 hover:border-green-500 hover:shadow-md transition-all flex flex-col items-center justify-center text-center"
          >
          ...
          <Link
            href="/(auth)/dashboard/pqr/create"
            className="bg-white p-4 rounded-xl border border-gray-200 hover:border-blue-500 hover:shadow-md transition-all flex flex-col items-center justify-center text-center"
          >
          ...
          <Link
            ...
            className="bg-white p-4 rounded-xl border border-gray-200 hover:border-purple-500 hover:shadow-md transition-all flex flex-col items-center justify-center text-center"
          >
          ...
          <Link
            ...
            className="bg-white p-4 rounded-xl border border-gray-200 hover:border-indigo-500 hover:shadow-md transition-all flex flex-col items-center justify-center text-center"
          >
