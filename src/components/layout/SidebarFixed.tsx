// src/components/layout/SidebarFixed.tsx
"use client";
...
export default function SidebarFixed({
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      subitems: [
        { label: language === "Español" ? "Registro" : "Registry", path: "/dashboard/residents/registry" },
      ],
    },
    {
      ...
      subitems: [
        { label: language === "Español" ? "Registro" : "Registry", path: "/dashboard/users/registry" },
      ],
    },
    {
    ...
    },
    {
      ...
      subitems: [
        ...
        { label: language === "Español" ? "APIs" : "APIs", path: "/dashboard/configuration/api" },
