...
export default function ReceptionSidebar({
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      subitems: [
        {
          label: language === "Español" ? "Registro de Entrada" : "Check-in",
          path: "/reception/visitors/check-in",
        },
        {
          label: language === "Español" ? "Registro de Salida" : "Check-out",
          path: "/reception/visitors/check-out",
        },
        {
          label: language === "Español" ? "Historial" : "History",
          path: "/reception/visitors/history",
        },
        {
          label:
            language === "Español"
              ...
              : "Regular Visitors",
          path: "/reception/visitors/regular",
        },
      ],
    },
    {
      ...
      subitems: [
        {
          label:
            language === "Español"
              ...
              : "Package Reception",
          path: "/reception/packages/reception",
        },
        {
          label:
            language === "Español"
              ? "Entrega a Residentes"
              : "Delivery to Residents",
          path: "/reception/packages/delivery",
        },
        {
          label: language === "Español" ? "Historial" : "History",
          path: "/reception/packages/history",
        },
      ],
    },
    {
      ...
      subitems: [
        {
          label:
            language === "Español" ? "Registrar Incidente" : "Log Incident",
          path: "/reception/log/incident",
        },
        {
          label: language === "Español" ? "Novedades del Día" : "Daily Updates",
          path: "/reception/log/daily",
        },
        {
          label: language === "Español" ? "Historial" : "History",
          path: "/reception/log/history",
        },
      ],
    },
    {
      ...
      subitems: [
        {
          ...
          path: "/reception/communications",
        },
        {
          label: language === "Español" ? "Citofonía" : "Intercom",
          path: "/reception/communications/intercom",
        },
        {
          label: language === "Español" ? "Mensajes" : "Messages",
          path: "/reception/communications/messages",
        },
      ],
    },
    {
