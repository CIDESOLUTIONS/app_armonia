...
import {
  ...
  Notification,
  Message,
} from "@/lib/communications/real-time-context";
...
export default function NotificationCenterThemed({
  ...
  const flattenedMessages = Object.values(messages)
    .flat()
    .sort(
      (a, b) =>
      ...
      <div className="flex space-x-2">
        ...
        >
          ...
          {unreadNotificationsCount > 0 && (
            <Badge
              className={`absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center p-0 ${primaryColor ? "bg-red-500" : "bg-red-500 dark:bg-red-600"}`}
            >
          ...
          <CardHeader className="p-3 pb-0">
            ...
            <TabsList className="grid grid-cols-2 mt-2">
              <TabsTrigger
                ...
                className={
                  activeTab === "notifications" ? "data-[state=active]" : ""
                }
              ...
              >
                ...
                {unreadNotificationsCount > 0 && (
                  <Badge
                    className={`ml-2 ${primaryColor ? "bg-red-500" : "bg-red-500 dark:bg-red-600"}`}
                  >
                    {unreadNotificationsCount}
                  </Badge>
                )}
              ...
              <TabsTrigger
                ...
                className={
                  activeTab === "messages" ? "data-[state=active]" : ""
                }
              ...
              <TabsContent value="notifications" className="m-0">
                <div className="flex justify-between items-center px-3 py-2 border-t border-b">
                  <div className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    {translate("notifications", language).toLowerCase()}
                  </div>
                  <div className="flex space-x-2">
                    <Button
                      variant="ghost"
                      ...
                      {notifications.map((notification) => (
                        ...
                        >
                          <div className="flex items-start">
                            <div
                              className={`h-2 w-2 mt-1.5 rounded-full mr-2 ${getNotificationColor(notification.type)}`}
                            />
              ...
              <TabsContent value="messages" className="m-0">
                <div className="flex justify-between items-center px-3 py-2 border-t border-b">
                  <div className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    {translate("messages", language).toLowerCase()}
                  </div>
                  <div className="flex space-x-2">
                    <Button
                      variant="ghost"
                  ...
                  {flattenedMessages.length === 0 ? (
                    ...
                    <div>
                      {uniqueSenders.map((senderId) => {
                        ...
                        const unreadCount = senderMessages.filter(
                          (m) => !m.read,
                        ).length;
