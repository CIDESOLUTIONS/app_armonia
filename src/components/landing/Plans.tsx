...
const translations = {
  es: {
    ...
    description:
      "Desde pequeñas comunidades hasta grandes portafolios, tenemos un plan que se ajusta a tus necesidades.",
    monthly: "Mensual",
    ...
    plans: {
      ...
      standard: {
        ...
        description:
          "La solución ideal para la mayoría de conjuntos residenciales.",
        features: [
      ...
      premium: {
        ...
        description:
          "Para administraciones que buscan la máxima eficiencia y valor.",
        features: [
      ...
      enterprise: {
        ...
        price: "Personalizado",
        description:
          "Para empresas que administran múltiples propiedades y requieren marca blanca.",
        features: [
      ...
      democracy: {
        ...
        price: "Por Evento",
        description:
          "Contrata nuestro módulo de asambleas como un servicio independiente.",
        features: [
