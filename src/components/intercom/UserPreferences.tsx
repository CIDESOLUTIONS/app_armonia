    ...
    const fetchData = async () => {
      try {
        ...
        if (preferences) {
          ...
          setValue(
            "allowedVisitorTypes",
            preferences.allowedVisitorTypes || [],
          );
            ...
            <Grid item xs={12}>
              ...
              {watchTelegramEnabled && (
                <Box mt={2}>
                  ...
                  >
                    Para vincular tu cuenta, envía un mensaje al bot
                    @ArmoniaIntercomBot con el comando /start
                  </Typography>
                </Box>
              )}
            </Grid>
                ...
                >
                  <Box mt={2}>
                    ...
                    <Typography
                      ...
                      sx={{ display: "block", mt: 1 }}
                    >
                      Durante este período no recibirás notificaciones de
                      visitantes
                    </Typography>
                  </Box>
                </LocalizationProvider>
