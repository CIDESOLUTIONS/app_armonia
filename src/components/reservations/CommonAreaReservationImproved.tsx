      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Administra tus reservas y pagos de instalaciones comunitarias
          </p>
        </div>
        <Button
          ...
          <div className="space-y-4">
            ...
            {selectedArea?.hasFee && (
              <Alert>
                ...
                <AlertDescription>
                  Esta reserva requiere un pago de{" "}
                  {formatCurrency(selectedArea.feeAmount || 0)}. Podrás
                  completar el pago después de crear la reserva.
                </AlertDescription>
              </Alert>
            )}
            ...
            {selectedArea?.requiresApproval && (
              <Alert>
                ...
                <AlertDescription>
                  Esta reserva debe ser aprobada por el administrador antes de
                  ser confirmada.
                </AlertDescription>
              </Alert>
            )}
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                ...
                !reservationForm.startDateTime ||
                !reservationForm.endDateTime
              }
            >
              {isCreatingReservation ? (
                <>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    <strong>Área:</strong>{" "}
                    {selectedReservation.commonArea?.name}
                  </p>
                  <p>
                    <strong>Fecha:</strong>{" "}
                    {format(
                      new Date(selectedReservation.startDateTime),
                      "PPP",
                      { locale: es },
                    )}
                  </p>
                  <p>
                    ...
                    -{" "}
                    {format(new Date(selectedReservation.endDateTime), "HH:mm")}
                  </p>
                  <p>
                    <strong>Asistentes:</strong> {selectedReservation.attendees}
                  </p>
