    ...
    const loadPQRDetails = async () => {
      try {
        ...
        const mockPQR: PQR = {
          ...
          description:
            "Hay una gotera grande en el parqueadero comunal que está afectando mi vehículo. He notado que cuando llueve, cae agua directamente sobre donde estaciono, lo que está causando daños a la pintura. Por favor, solicito una revisión y reparación urgente del techo.",
          ...
          response:
            "Se realizó una inspección inicial y se detectó la filtración. Se ha programado una reparación con el contratista para la próxima semana.",
        ...
        const mockComments: Comment[] = [
          {
            ...
            content:
              "Necesito que se resuelva pronto, está afectando la pintura de mi vehículo.",
          ...
          },
          {
            ...
            userName: "Carlos Martínez",
            content:
              "Se ha identificado una filtración en el techo. Necesitamos contratar una impermeabilización.",
          ...
          },
          {
            ...
            userName: "Carlos Martínez",
            content:
              "Hemos programado el servicio de reparación para el próximo martes. Le informaremos cuando esté completado.",
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <Select
                        value={newStatus}
                        onValueChange={(value) =>
                          setNewStatus(value as PQRStatus)
                        }
                      >
                        ...
                        <SelectContent>
                          <SelectItem value={PQRStatus.PENDING}>
                            Pendiente
                          </SelectItem>
                          <SelectItem value={PQRStatus.IN_PROGRESS}>
                            En Proceso
                          </SelectItem>
                          <SelectItem value={PQRStatus.RESOLVED}>
                            Resuelto
                          </SelectItem>
                          <SelectItem value={PQRStatus.CLOSED}>
                            Cerrado
                          </SelectItem>
                          <SelectItem value={PQRStatus.CANCELLED}>
                            Cancelado
                          </SelectItem>
                        </SelectContent>
                      </Select>
                      <Button
                        ...
                        disabled={
                          isUpdating || newStatus === pqr.status || !newStatus
                        }
                      >
                        Actualizar
                      </Button>
