...
class SeoOptimizationService {
  private metaTags: MetaTags = {
    ...
    description:
      "Plataforma completa para la gestión de comunidades, asambleas, pagos, comunicaciones y más. Simplifica la administración de tu edificio o conjunto residencial.",
    keywords:
      "gestión comunidades, administración edificios, asambleas virtuales, pagos comunitarios, comunicación residentes",
    ogTitle: "Armonía - Solución integral para comunidades",
    ogDescription:
      "Transforma la gestión de tu comunidad con Armonía. Plataforma todo en uno para administración, comunicación y servicios comunitarios.",
    ogImage: "/images/armonia-social-share.jpg",
    twitterCard: "summary_large_image",
    twitterTitle: "Armonía - Gestión comunitaria simplificada",
    twitterDescription:
      "Administra tu comunidad de forma eficiente con Armonía. Asambleas, pagos, comunicaciones y más en una sola plataforma.",
  ...
  public async optimizeImage(
    ...
    try {
      ...
      await sharpInstance.toFormat(format, { quality }).toFile(outputPath);
