...
const texts = {
  es: {
    ...
    premiumPlanDesc:
      "Para conjuntos de hasta 90 unidades. ($USD 1/mes por unidad residencial adicional)",
  ...
  en: {
    ...
    description:
      "Complete the required information to register your complex in the Armonía platform.",
    stepPlan: "Plan",
    stepComplex: "Complex",
    stepAccount: "Account",
    ...
    standardPlanDesc:
      "For complexes with up to 40 units. ($USD 1/month per additional residential unit)",
    ...
    premiumPlanDesc:
      "For complexes with up to 90 units. ($USD 1/month per additional residential unit)",
...
export default function RegisterComplex() {
    ...
    try {
      ...
      if ((plan === "standard" || plan === "premium") && !txId) {
        ...
        if (storedTransactionId) {
          ...
          console.warn(
            "Pago marcado como completado pero falta ID de transacción",
          );
        } else {
          throw new Error(
            "Se requiere completar el pago para registrar este plan",
          );
        }
      }
  ...
  return (
    <div
      className={`flex flex-col min-h-screen ${theme === "Oscuro" ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-900"}`}
    >
      {/* Header compartido */}
      <Header
        theme={theme}
      ...
      <div className="pt-5 flex-grow">
        {" "}
        {/* Reducido aún más: de pt-10 a pt-5 */}
        <div className="container mx-auto px-4 py-2">
          ...
          <div className="mb-4">
            <div className="flex justify-center items-center">
              <div
                className={`flex items-center ${step === 1 ? "text-indigo-600" : step > 1 ? "text-green-500" : "text-gray-400"}`}
              >
                <div
                  className={`w-10 h-10 rounded-full border-2 flex items-center justify-center ${step === 1 ? "border-indigo-600 text-indigo-600" : step > 1 ? "border-green-500 text-green-500" : "border-gray-300 text-gray-400"}`}
                >
              ...
              <div
                className={`w-16 md:w-32 h-1 mx-2 ${step > 1 ? "bg-green-500" : "bg-gray-300"}`}
              ></div>

              <div
                className={`flex items-center ${step === 2 ? "text-indigo-600" : step > 2 ? "text-green-500" : "text-gray-400"}`}
              >
                <div
                  className={`w-10 h-10 rounded-full border-2 flex items-center justify-center ${step === 2 ? "border-indigo-600 text-indigo-600" : step > 2 ? "border-green-500 text-green-500" : "border-gray-300 text-gray-400"}`}
                >
              ...
              <div
                className={`w-16 md:w-32 h-1 mx-2 ${step > 2 ? "bg-green-500" : "bg-gray-300"}`}
              ></div>
              ...
              >
                <div
                  className={`w-10 h-10 rounded-full border-2 flex items-center justify-center ${step === 3 ? "border-indigo-600 text-indigo-600" : "border-gray-300 text-gray-400"}`}
                >
                  3
                </div>
                <span className="ml-2 text-sm font-medium">
          ...
          {step === 1 && (
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div
                  className={`bg-white p-6 rounded-lg border ${plan === "basic" ? "border-indigo-500 ring-2 ring-indigo-500" : "border-gray-200"} shadow-md hover:shadow-xl transition-all cursor-pointer`}
                ...
                <div
                  className={`bg-white p-6 rounded-lg border ${plan === "standard" ? "border-indigo-500 ring-2 ring-indigo-500" : "border-gray-200"} shadow-md hover:shadow-xl transition-all cursor-pointer relative`}
                ...
                <div
                  className={`bg-white p-6 rounded-lg border ${plan === "premium" ? "border-indigo-500 ring-2 ring-indigo-500" : "border-gray-200"} shadow-md hover:shadow-xl transition-all cursor-pointer`}
                  ...
                  <div>
                    ...
                    {validationErrors.units ? (
                      ...
                      <>
                        ...
                        {plan === "standard" &&
                          parseInt(formData.units) > 40 && (
                            <p className="mt-1 text-sm text-red-600">
                              {t.standardPlanLimit}
                            </p>
                          )}
                        {plan === "premium" &&
                          parseInt(formData.units) > 90 && (
                            <p className="mt-1 text-sm text-red-600">
                              {t.premiumPlanLimit}
                            </p>
                          )}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      <div className="flex items-center">
                        <input
                          ...
                          className="mr-2"
                        />
                        <label htmlFor="service-pool" className="text-gray-700">
                          {t.pool}
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="mr-2"
                        />
                        <label htmlFor="service-gym" className="text-gray-700">
                          {t.gym}
                        </label>
                      </div>
                      <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="mr-2"
                        />
                        <label htmlFor="service-bbq" className="text-gray-700">
                          {t.bbq}
                        </label>
                      </div>
                      <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="mr-2"
                        />
                        <label htmlFor="service-park" className="text-gray-700">
                          {t.playground}
                        </label>
                      </div>
                      <div className="flex items-center">
