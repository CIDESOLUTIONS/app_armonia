...
export async function GET(
  ...
  try {
    ...
    const event = await communityEventService.getEventById(
      eventId,
      payload.complexId,
    );
    ...
    ServerLogger.info(
      `Evento ${eventId} obtenido para el complejo ${payload.complexId}`,
    );
...
export async function PUT(
  ...
  try {
    ...
    const communityEventService = new CommunityEventService(payload.schemaName);
    const updatedEvent = await communityEventService.updateEvent(
      eventId,
      payload.complexId,
      {
        ...validatedData,
    ...
    ServerLogger.info(
      `Evento ${eventId} actualizado en complejo ${payload.complexId}`,
    );
...
export async function DELETE(
  ...
  try {
    ...
    ServerLogger.info(
      `Evento ${eventId} eliminado del complejo ${payload.complexId}`,
    );
    return NextResponse.json(
