...
export async function GET(
  ...
  try {
    ...
    ServerLogger.info(
      `Pago ${paymentId} obtenido para el complejo ${payload.complexId}`,
    );
...
export async function PUT(
  ...
  try {
    ...
    ServerLogger.info(
      `Pago ${paymentId} actualizado en complejo ${payload.complexId}`,
    );
...
export async function DELETE(
  ...
  try {
    ...
    ServerLogger.info(
      `Pago ${paymentId} eliminado del complejo ${payload.complexId}`,
    );
    return NextResponse.json(
