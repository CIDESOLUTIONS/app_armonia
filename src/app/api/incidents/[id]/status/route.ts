...
export async function POST(
  ...
  try {
    ...
    const reason = requestData.reason
      ? sanitizeInput(requestData.reason)
      : undefined;
    const resolution = requestData.resolution
      ? sanitizeInput(requestData.resolution)
      : undefined;
    const rootCause = requestData.rootCause
      ? sanitizeInput(requestData.rootCause)
      : undefined;
    const preventiveActions = requestData.preventiveActions
      ? sanitizeInput(requestData.preventiveActions)
      : undefined;
