...
export async function PUT(
  ...
  try {
    ...
    const sanitizedData = {
      ...
      expectedArrivalDate: requestData.expectedArrivalDate
        ? new Date(requestData.expectedArrivalDate)
        : undefined,
    ...
    const preRegistration = await preRegistrationService.updatePreRegistration(
      id,
      sanitizedData,
    );
...
export async function POST(
  ...
  if (isCancelRequest) {
    try {
      ...
      const preRegistration =
        await preRegistrationService.cancelPreRegistration(id, sanitizedData);
