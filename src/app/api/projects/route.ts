...
export async function GET(request: NextRequest) {
  try {
    ...
    ServerLogger.info(
      `Proyectos listados para el complejo ${payload.complexId}`,
    );
...
export async function POST(request: NextRequest) {
  try {
    ...
    ServerLogger.info(
      `Proyecto creado: ${newProject.name} por ${payload.email} en complejo ${payload.complexId}`,
    );
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (!id) {
      return NextResponse.json(
        { message: "ID de proyecto requerido para actualizar" },
        { status: 400 },
      );
    }
    ...
    ServerLogger.info(
      `Proyecto actualizado: ${updatedProject.name} en complejo ${payload.complexId}`,
    );
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (!id) {
      return NextResponse.json(
        { message: "ID de proyecto requerido para eliminar" },
        { status: 400 },
      );
    }
    ...
    ServerLogger.info(
      `Proyecto eliminado: ID ${id} en complejo ${payload.complexId}`,
    );
    return NextResponse.json(
