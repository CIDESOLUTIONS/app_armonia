...
export async function POST(request: NextRequest) {
  try {
    ...
    ServerLogger.info(
      `Bien común creado: ${newCommonAsset.name} en complejo ${payload.complexId}`,
    );
    ...
    return NextResponse.json(
      { message: "Error al crear bien común" },
      { status: 500 },
    );
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (!id) {
      return NextResponse.json(
        { message: "ID de bien común requerido para actualizar" },
        { status: 400 },
      );
    }
    ...
    ServerLogger.info(
      `Bien común actualizado: ${updatedCommonAsset.name} en complejo ${payload.complexId}`,
    );
    ...
    return NextResponse.json(
      { message: "Error al actualizar bien común" },
      { status: 500 },
    );
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (!id) {
      return NextResponse.json(
        { message: "ID de bien común requerido para eliminar" },
        { status: 400 },
      );
    }
    ...
    ServerLogger.info(
      `Bien común eliminado: ID ${id} en complejo ${payload.complexId}`,
    );
    return NextResponse.json(
    ...
    return NextResponse.json(
      { message: "Error al eliminar bien común" },
      { status: 500 },
    );
  }
}
