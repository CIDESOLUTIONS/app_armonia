  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Conjuntos Registrados (Freemium)</CardTitle>
            <Users className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            {/* TODO: Reemplazar con datos dinámicos de la base de datos */}
            <div className="text-2xl font-bold">Básico: 150, Estándar: 60, Premium: 25</div>
            <p className="text-xs text-muted-foreground">+10 Básico, +5 Estándar, +2 Premium desde el mes pasado</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
