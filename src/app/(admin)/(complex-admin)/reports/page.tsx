            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Genera reportes de ingresos, egresos, presupuestos y más.
                </p>
              </Link>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Visualiza la actividad de usuarios y del sistema.
                </p>
              </Link>

              <Link
                href="/admin/reports/service-usage"
                className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer flex flex-col items-center text-center"
              >
                ...
                <p className="text-gray-600 text-sm">
                  Analiza la ocupación de áreas comunes y servicios.
                </p>
              </Link>

              <Link
                href="/admin/reports/pqr"
                className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer flex flex-col items-center text-center"
              >
                ...
                <p className="text-gray-600 text-sm">
                  Obtén métricas sobre peticiones, quejas y reclamos.
                </p>
              </Link>
            </div>
          </div>
