  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          <h2 className="text-xl font-semibold mb-4 flex items-center">
            <Fingerprint className="mr-2" /> Enrolamiento Biométrico
          </h2>
          <p className="text-gray-600 mb-4">
            Gestione el enrolamiento de huellas dactilares o reconocimiento
            facial para el personal autorizado.
          </p>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          <h2 className="text-xl font-semibold mb-4 flex items-center">
            <Lock className="mr-2" /> Zonas Restringidas
          </h2>
          <p className="text-gray-600 mb-4">
            Defina y gestione zonas de acceso restringido dentro del conjunto
            residencial.
          </p>
      ...
      <div className="mt-8 bg-white shadow-md rounded-lg p-6">
        ...
        <p className="text-gray-600">
          El historial detallado de accesos y eventos de seguridad se mostrará
          aquí.
        </p>
      </div>
    </div>
