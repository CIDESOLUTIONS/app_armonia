...
const texts = {
  es: {
    ...
    securePaymentDesc:
      "Su información es procesada de forma segura. Sus datos de pago nunca son almacenados.",
    ...
    testModeWarning:
      "MODO DE PRUEBA: Use cualquier número de tarjeta para simular un pago exitoso.",
  ...
  en: {
    ...
    securePaymentDesc:
      "Your information is processed securely. We do not store your payment details.",
    ...
    testModeWarning:
      "TEST MODE: Use any card number to simulate a successful payment.",
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <div className="border-t border-gray-200 pt-4 space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        {priceDetails.symbol}
                        {priceDetails.tax.toLocaleString()} {priceDetails.Code}
                      </span>
                    </div>
