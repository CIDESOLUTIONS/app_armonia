  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      toast({
        title: "Éxito",
        description:
          "Reporte de PQR generado correctamente (simulado). Descargando...",
      });
      // Simulate file download
      const blob = new Blob(
        [`Reporte de PQR de ${reportType} del ${startDate} al ${endDate}`],
        { type: "text/plain" },
      );
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="mt-8 bg-white shadow-md rounded-lg p-6">
        ...
        <p className="text-gray-600">
          Aquí se mostrará un historial de los reportes de PQR generados
          previamente.
        </p>
      </div>
    </div>
