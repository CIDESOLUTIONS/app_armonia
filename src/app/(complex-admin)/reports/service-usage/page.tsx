  ...
  const handleGenerateReport = async () => {
    if (!reportType || !startDate || !endDate) {
      toast({
        title: "Error",
        description:
          "Por favor, seleccione un tipo de reporte y un rango de fechas.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        title: "Éxito",
        description:
          "Reporte de uso de servicios generado correctamente (simulado). Descargando...",
      });
      // Simulate file download
      const blob = new Blob(
        [
          `Reporte de uso de servicios de ${reportType} del ${startDate} al ${endDate}`,
        ],
        { type: "text/plain" },
      );
      ...
      const description =
        error instanceof Error
          ...
          : "Error al generar el reporte de uso de servicios.";
      toast({
        title: "Error",
        description,
        variant: "destructive",
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        <h2 className="text-xl font-semibold mb-4">
          Generar Nuevo Reporte de Uso de Servicios
        </h2>
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            ...
            <Select value={reportType} onValueChange={setReportType}>
              ...
              <SelectContent>
                <SelectItem value="common_area_occupancy">
                  Ocupación de Áreas Comunes
                </SelectItem>
                <SelectItem value="reservation_frequency">
                  Frecuencia de Reservas
                </SelectItem>
                <SelectItem value="service_revenue">
      ...
      <div className="mt-8 bg-white shadow-md rounded-lg p-6">
        ...
        <p className="text-gray-600">
          Aquí se mostrará un historial de los reportes de uso de servicios
