  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      toast({
        title: "Éxito",
        description:
          "Reporte financiero generado correctamente (simulado). Descargando...",
      });
      // Simulate file download
      const blob = new Blob(
        [`Reporte financiero de ${reportType} del ${startDate} al ${endDate}`],
        { type: "text/plain" },
      );
      ...
      const description =
        error instanceof Error
          ? "Error al generar el reporte financiero: " + error.message
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        <h2 className="text-xl font-semibold mb-4">
          Generar Nuevo Reporte Financiero
        </h2>
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            ...
            <Select value={reportType} onValueChange={setReportType}>
              ...
              <SelectContent>
                <SelectItem value="income_expense">
                  Ingresos y Egresos
                </SelectItem>
                <SelectItem value="balance_sheet">Balance General</SelectItem>
                <SelectItem value="budget_comparison">
      ...
      <div className="mt-8 bg-white shadow-md rounded-lg p-6">
        ...
        <p className="text-gray-600">
          Aquí se mostrará un historial de los reportes financieros generados
          previamente.
        </p>
      </div>
    </div>
