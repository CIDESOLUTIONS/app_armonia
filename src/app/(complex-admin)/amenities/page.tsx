...
export default function CommonAreasPage() {
  ...
  const [currentCommonArea, setCurrentCommonArea] = useState<CommonArea | null>(
    null,
  );

  const [formState, setFormState] = useState<
    CreateCommonAreaDto | UpdateCommonAreaDto
  >({
    name: "",
    description: "",
          ...
          {commonAreas.length > 0 ? (
            commonAreas.map((area) => (
              <TableRow key={area.id}>
                ...
                <TableCell>
                  {area.hourlyRate ? `$${area.hourlyRate.toFixed(2)}` : "N/A"}
                </TableCell>
                <TableCell>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => handleEditCommonArea(area)}
                  >
          ...
          <form onSubmit={handleSubmit} className="grid gap-4 py-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormState({ ...formState, type: value as CommonAreaType })
                }
              >
                <SelectTrigger>
            ...
            <div>
              <Label htmlFor="availableDays">
                Días Disponibles (separados por coma)
              </Label>
              <Input
                id="availableDays"
                value={formState.availableDays?.join(", ")}
                onChange={(e) =>
                  setFormState({
                    ...formState,
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormState({ ...formState, openingTime: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormState({ ...formState, closingTime: e.target.value })
                }
              />
            </div>
          </div>
