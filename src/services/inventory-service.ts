...
class InventoryService {
  ...
  async getProperty(id: number): Promise<Property> {
    try {
      return await get<Property>(`/api/inventory/properties/${id}`, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async createProperty(data: CreatePropertyDto): Promise<Property> {
    try {
      return await post<Property>("/api/inventory/properties", data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async updateProperty(id: number, data: UpdatePropertyDto): Promise<Property> {
    try {
      return await put<Property>(`/api/inventory/properties/${id}`, data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async addOwner(data: CreateOwnerDto): Promise<PropertyOwner> {
    try {
      return await post<PropertyOwner>("/api/inventory/owners", data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async addResident(data: CreateResidentDto): Promise<Resident> {
    try {
      return await post<Resident>("/api/inventory/residents", data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async addVehicle(data: CreateVehicleDto): Promise<Vehicle> {
    try {
      return await post<Vehicle>("/api/inventory/vehicles", data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async addPet(data: CreatePetDto): Promise<Pet> {
    try {
      return await post<Pet>("/api/inventory/pets", data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async getPropertyPets(propertyId: number): Promise<Pet[]> {
    try {
      return await get<Pet[]>(`/api/inventory/properties/${propertyId}/pets`, {
        schema: this.schema,
      });
    } catch (error) {
      ServerLogger.error(
        `Error al obtener mascotas de propiedad ${propertyId}:`,
        error,
      );
      throw error;
    }
  ...
  async getCommonAreas(): Promise<CommonArea[]> {
    try {
      return await get<CommonArea[]>("/api/inventory/common-areas", {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async getParkingSpots(): Promise<ParkingSpot[]> {
    try {
      return await get<ParkingSpot[]>("/api/inventory/parking-spots", {
        schema: this.schema,
      });
    } catch (error) {
   ...
   * @param propertyId ID de la propiedad
   */
  async assignParkingSpot(
    parkingId: number,
    propertyId: number,
  ): Promise<ParkingSpot> {
    try {
      return await put<ParkingSpot>(
        `/api/inventory/parking-spots/${parkingId}/assign`,
        { propertyId },
        { schema: this.schema },
      );
    } catch (error) {
      ServerLogger.error(
        `Error al asignar estacionamiento ${parkingId} a propiedad ${propertyId}:`,
        error,
      );
      throw error;
    }
  ...
  async createUserForResident(
    ...
    try {
      return await post(
        "/api/inventory/residents/create-user",
        {
          residentId,
          email,
          password,
      ...
      ServerLogger.error(
        `Error al crear usuario para residente ${residentId}:`,
        error,
      );
      throw error;
    }
