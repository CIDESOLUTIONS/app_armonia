...
class FinanceService {
  ...
  async getFee(id: number): Promise<Fee> {
    try {
      return await get<Fee>(`/api/finances/fees/${id}`, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async createFee(data: CreateFeeDto): Promise<Fee> {
    try {
      return await post<Fee>("/api/finances/fees", data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async updateFee(id: number, data: UpdateFeeDto): Promise<Fee> {
    try {
      return await put<Fee>(`/api/finances/fees/${id}`, data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async createPayment(data: CreatePaymentDto): Promise<Payment> {
    try {
      return await post<Payment>("/api/finances/payments", data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async getPropertyPayments(propertyId: number): Promise<Payment[]> {
    try {
      return await get<Payment[]>(
        `/api/finances/properties/${propertyId}/payments`,
        { schema: this.schema },
      );
    } catch (error) {
      ServerLogger.error(
  ...
  async getPropertyBalance(propertyId: number) {
    try {
      return await get(`/api/finances/properties/${propertyId}/balance`, {
        schema: this.schema,
      });
    } catch (error) {
      ServerLogger.error(
  ...
  async createBudget(data: CreateBudgetDto): Promise<Budget> {
    try {
      return await post<Budget>("/api/finances/budgets", data, {
        schema: this.schema,
      });
    } catch (error) {
  ...
  async getBudgetsByYear(year: number): Promise<Budget[]> {
    try {
      return await get<Budget[]>(`/api/finances/budgets?year=${year}`, {
        schema: this.schema,
      });
    } catch (error) {
      ServerLogger.error(
  ...
  async approveBudget(id: number): Promise<Budget> {
    try {
      return await put<Budget>(
        `/api/finances/budgets/${id}/approve`,
        {},
        { schema: this.schema },
      );
    } catch (error) {
