...
describe("InvoiceRuleService", () => {
  ...
  describe("getRules", () => {
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      await expect(service.getRules()).rejects.toThrow(
        "Error al obtener reglas de facturación",
      );
  ...
  describe("getRuleById", () => {
    ...
    it("debe lanzar error si la regla no existe", async () => {
      ...
      // Ejecutar método y verificar que lanza error
      await expect(service.getRuleById(999)).rejects.toThrow(
        "Regla con ID 999 no encontrada",
      );
    });
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al obtener regla de facturación con ID 1:",
        mockError,
      );
    });
  });
  ...
  describe("createRule", () => {
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al crear regla de facturación:",
        mockError,
      );
    });
  });
  ...
  describe("updateRule", () => {
    ...
    it("debe lanzar error si la regla no existe", async () => {
      ...
      // Ejecutar método y verificar que lanza error
      await expect(service.updateRule(999, {}, 1)).rejects.toThrow(
        "Regla con ID 999 no encontrada",
      );
    });
    ...
    it("debe validar los datos de la regla", async () => {
      // Configurar mock para verificar existencia
      mockPrisma.invoiceRule.findUnique.mockResolvedValue({
        id: 1,
        name: "Regla Original",
      });
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al actualizar regla de facturación con ID 1:",
        mockError,
      );
    });
  });
  ...
  describe("deleteRule", () => {
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al eliminar regla de facturación con ID 1:",
        mockError,
      );
    });
  });
  ...
  describe("toggleRuleActive", () => {
    ...
    it("debe lanzar error si la regla no existe", async () => {
      ...
      // Ejecutar método y verificar que lanza error
      await expect(service.toggleRuleActive(999, true, 1)).rejects.toThrow(
        "Regla con ID 999 no encontrada",
      );
    });
  ...
  describe("executeRule", () => {
    ...
    it("debe lanzar error si la regla está inactiva", async () => {
      ...
      await expect(service.executeRule(1, 1)).rejects.toThrow(
        "No se puede ejecutar una regla inactiva",
      );
    });
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al ejecutar regla de facturación 1:",
        mockError,
      );
    });
  });
  ...
  describe("processScheduledRules", () => {
    ...
    it("debe manejar errores generales correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al procesar reglas programadas:",
        mockError,
      );
    });
  });
