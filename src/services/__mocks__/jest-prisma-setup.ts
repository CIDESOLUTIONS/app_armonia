...
import { PrismaClient, PQRCategory, PQRStatus, PQRPriority, VisitStatus, VisitType } from './prisma-client-extended';
...
export const prismaClientMockInstance = prismaClientMock;
export { PQRCategory, PQRStatus, PQRPriority, VisitStatus, VisitType };