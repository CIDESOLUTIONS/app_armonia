...
describe("BillingEngine", () => {
  ...
  describe("createPayment", () => {
    ...
    it("should validate payment request data", async () => {
      ...
      await expect(billingEngine.createPayment(invalidRequest)).rejects.toThrow(
    ...
    it("should handle missing gateway configuration", async () => {
      ...
      await expect(billingEngine.createPayment(paymentRequest)).rejects.toThrow(
  ...
  describe("createReservationPayment", () => {
    ...
    it("should create payment for reservation successfully", async () => {
      ...
      const result =
        await billingEngine.createReservationPayment(reservationPayment);
    ...
    it("should handle non-existent reservation", async () => {
      ...
      await expect(
        billingEngine.createReservationPayment(reservationPayment),
  ...
  describe("confirmPayment", () => {
    ...
    it("should validate confirmation data", async () => {
      ...
      await expect(
        billingEngine.confirmPayment("txn_123", invalidConfirmation),
      ).rejects.toThrow("Datos de confirmación inválidos");
    });
  });
  ...
  describe("getTransactionStatus", () => {
    ...
    it("should handle non-existent transaction", async () => {
      ...
      await expect(
        billingEngine.getTransactionStatus("non_existent"),
  ...
  describe("processRefund", () => {
    ...
    it("should not refund non-completed transactions", async () => {
      ...
      await expect(billingEngine.processRefund("txn_123")).rejects.toThrow(
  ...
  describe("Error Handling", () => {
    it("should handle database errors gracefully", async () => {
      mockPrisma.paymentSettings.findFirst.mockRejectedValue(
