...
describe("CommunicationService", () => {
  ...
  describe("notifyUser", () => {
    ...
    it("should throw an error if user does not exist", async () => {
      ...
      await expect(
        communicationService.notifyUser(999, {
          type: "info",
          title: "Test Notification",
          message: "This is a test notification",
          sourceType: "system",
  ...
  describe("markNotificationAsRead", () => {
    ...
    it("should throw an error if notification does not belong to user", async () => {
      ...
      // Call the service method and expect it to throw
      await expect(
        communicationService.markNotificationAsRead("notif-999", 1),
  ...
  describe("markAnnouncementAsRead", () => {
    it("should mark an announcement as read", async () => {
      ...
      // Call the service method
      const result = await communicationService.markAnnouncementAsRead(
        "ann-123",
        1,
      );
    ...
    it("should return existing read record if already read", async () => {
      ...
      mockPrisma.announcementRead.findUnique.mockResolvedValue(
        mockExistingRead,
      );
