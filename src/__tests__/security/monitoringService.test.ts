...
describe("MonitoringService", () => {
  ...
  describe("createMonitoringConfig", () => {
    it("should create a monitoring configuration successfully", async () => {
      ...
      // Act
      const result = await monitoringService.createMonitoringConfig(
        configData,
        123,
      );
    ...
    it("should handle errors when creating a monitoring configuration", async () => {
      ...
      // Act & Assert
      await expect(
        monitoringService.createMonitoringConfig(configData, 123),
  ...
  describe("updateMonitoringConfig", () => {
    ...
    it("should handle errors when updating a monitoring configuration", async () => {
      ...
      // Act & Assert
      await expect(
        monitoringService.updateMonitoringConfig(configId, updateData, 123),
  ...
  describe("deleteMonitoringConfig", () => {
    it("should delete a monitoring configuration and related data successfully", async () => {
      ...
      mockPrisma.alert.findMany.mockResolvedValue([{ id: 101 }, { id: 102 }]);
      ...
      // Act
      const result = await monitoringService.deleteMonitoringConfig(
        configId,
        123,
      );
    ...
    it("should handle errors when deleting a monitoring configuration", async () => {
      ...
      // Act & Assert
      await expect(
        monitoringService.deleteMonitoringConfig(configId, 123),
  ...
  describe("getMonitoringConfigs", () => {
    ...
    it("should handle errors when getting monitoring configurations", async () => {
      ...
      // Act & Assert
      await expect(monitoringService.getMonitoringConfigs()).rejects.toThrow(
  ...
  describe("executeCheck", () => {
    ...
    it("should handle errors during check execution", async () => {
      ...
      // Act
      await expect(monitoringService.executeCheck(configId)).rejects.toThrow(
        "Error al ejecutar verificación de monitoreo",
      );
  ...
  describe("getActiveAlerts", () => {
    ...
    it("should handle errors when getting active alerts", async () => {
      ...
      // Act & Assert
      await expect(monitoringService.getActiveAlerts()).rejects.toThrow(
  ...
  describe("getMonitoringStats", () => {
    ...
    it("should handle errors when getting statistics", async () => {
      ...
      // Act & Assert
      await expect(
        monitoringService.getMonitoringStats(configId, days),
