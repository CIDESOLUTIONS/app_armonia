...
import {
  GET as getPets,
  POST as postPets,
} from "@/app/api/inventory/pets/route";
import {
...
describe("Inventory API Integration Tests", () => {
  ...
  describe("Pets API", () => {
    describe("GET /api/inventory/pets", () => {
      it("should return pets successfully", async () => {
        ...
        const request = new NextRequest(
          "http://localhost:3000/api/inventory/pets?complexId=1",
        );
      ...
      it("should filter by propertyId when provided", async () => {
        ...
        const request = new NextRequest(
          "http://localhost:3000/api/inventory/pets?complexId=1&propertyId=5",
        );
        const response = await getPets(request);
      ...
      it("should return 400 for invalid complexId", async () => {
        const request = new NextRequest(
          "http://localhost:3000/api/inventory/pets?complexId=invalid",
        );
        const response = await getPets(request);
        const data = await response.json();
    ...
    describe("POST /api/inventory/pets", () => {
      it("should create pet successfully", async () => {
        ...
        const request = new NextRequest(
          "http://localhost:3000/api/inventory/pets",
          {
            method: "POST",
  ...
  describe("Properties API", () => {
    describe("GET /api/inventory/properties", () => {
      it("should return properties successfully", async () => {
        ...
        const request = new NextRequest(
          "http://localhost:3000/api/inventory/properties?complexId=1",
        );
    ...
    describe("POST /api/inventory/properties", () => {
      it("should create property successfully", async () => {
        ...
        mockInventoryService.createProperty.mockResolvedValue(
          mockCreatedProperty,
        );

        const request = new NextRequest(
          "http://localhost:3000/api/inventory/properties",
          {
            method: "POST",
  ...
  describe("Vehicles API", () => {
    describe("GET /api/inventory/vehicles", () => {
      it("should return vehicles successfully", async () => {
        ...
        const request = new NextRequest(
          "http://localhost:3000/api/inventory/vehicles?complexId=1",
        );
        ...
        expect(mockInventoryService.getVehicles).toHaveBeenCalledWith(
          1,
          undefined,
        );
      });
    ...
    describe("POST /api/inventory/vehicles", () => {
      it("should create vehicle successfully", async () => {
        ...
        mockInventoryService.createVehicle.mockResolvedValue(
          mockCreatedVehicle,
        );

        const request = new NextRequest(
          "http://localhost:3000/api/inventory/vehicles",
          {
            method: "POST",
  ...
  describe("Statistics API", () => {
    describe("GET /api/inventory/statistics", () => {
      it("should return inventory statistics successfully", async () => {
        ...
        const request = new NextRequest(
          "http://localhost:3000/api/inventory/statistics?complexId=1",
        );
  ...
  describe("Error Handling", () => {
    it("should handle service errors gracefully", async () => {
      mockInventoryService.getPets.mockRejectedValue(
