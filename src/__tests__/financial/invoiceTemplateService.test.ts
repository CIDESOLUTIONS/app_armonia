...
describe("InvoiceTemplateService", () => {
  ...
  describe("getTemplateById", () => {
    ...
    it("debe lanzar error si la plantilla no existe", async () => {
      ...
      await expect(service.getTemplateById(999)).rejects.toThrow(
        "Plantilla con ID 999 no encontrada",
      );
    });
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al obtener plantilla con ID 1:",
        mockError,
      );
    });
  });
  ...
  describe("updateTemplate", () => {
    it("debe actualizar una plantilla existente", async () => {
      ...
      mockPrisma.invoiceTemplate.findUnique.mockResolvedValue({
        id: templateId,
    ...
    it("debe lanzar error si la plantilla no existe", async () => {
      ...
      // Ejecutar método y verificar que lanza error
      await expect(service.updateTemplate(999, {}, 1)).rejects.toThrow(
        "Plantilla con ID 999 no encontrada",
      );
    });
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Ejecutar método y verificar que lanza error
      await expect(
        service.updateTemplate(1, templateData, 1),
      ).rejects.toThrow();

      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al actualizar plantilla con ID 1:",
        mockError,
      );
    });
  });
  ...
  describe("deleteTemplate", () => {
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al eliminar plantilla con ID 1:",
        mockError,
      );
    });
  });
  ...
  describe("setDefaultTemplate", () => {
    it("debe establecer una plantilla como predeterminada", async () => {
      ...
      // Configurar mock para actualización
      mockPrisma.invoiceTemplate.update.mockResolvedValueOnce({
        id: templateId,
        name: "Plantilla",
        isDefault: true,
      });
    ...
    it("debe lanzar error si la plantilla no existe", async () => {
      ...
      // Ejecutar método y verificar que lanza error
      await expect(service.setDefaultTemplate(999, 1)).rejects.toThrow(
        "Plantilla con ID 999 no encontrada",
      );
    });
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al establecer plantilla 1 como predeterminada:",
        mockError,
      );
    });
  });
  ...
  describe("renderInvoice", () => {
    ...
    it("debe usar la plantilla predeterminada si no se especifica templateId", async () => {
      ...
      // Configurar mocks
      mockPrisma.invoiceTemplate.findFirst.mockResolvedValue(
        mockDefaultTemplate,
      );
    ...
    it("debe manejar errores correctamente", async () => {
      ...
      // Verificar que se registró el error
      expect(ServerLogger.error).toHaveBeenCalledWith(
        "Error al renderizar factura 1 con plantilla 2:",
        mockError,
      );
    });
  });
