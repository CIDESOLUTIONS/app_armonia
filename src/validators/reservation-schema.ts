...
export const reservationSchema = z.object({
  ...
  attendees: z.number().int().min(1, "El número de asistentes debe ser al menos 1.").optional(),
  requiresPayment: z.boolean().optional(),
  paymentAmount: z.number().positive("El monto de pago debe ser positivo.").optional(),
