...
export type GetVotingQuestionsRequest = z.infer<
  typeof GetVotingQuestionsSchema
>;
...
export type CreateVotingQuestionRequest = z.infer<
  typeof CreateVotingQuestionSchema
>;
