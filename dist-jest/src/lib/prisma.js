...
export const prisma = (_a = globalForPrisma.prisma) !== null && _a !== void 0 ? _a : createPrismaClient();
 ...
 * @returns Instancia de PrismaClient
 */
export function getSchemaFromRequest(schema = 'public') {
 ...
 */
export function getSchemaFromReq(req) {
