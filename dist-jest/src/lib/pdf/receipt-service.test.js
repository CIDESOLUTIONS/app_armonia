...
describe('Receipt Service', () => {
    ...
    it('should generate a PDF receipt with correct data', () => __awaiter(void 0, void 0, void 0, function* () {
        const mockData = {
        ...
        const pdfBuffer = yield generateReceipt(mockData);
    ...
    it('should send a PDF receipt by email', () => __awaiter(void 0, void 0, void 0, function* () {
        const mockData = {
        ...
        const success = yield sendReceiptByEmail(mockData, mockEmail);
