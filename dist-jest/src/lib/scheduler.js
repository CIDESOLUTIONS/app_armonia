...
export function scheduleTask(taskId, taskFn, intervalMs, options = {}) {
...
export function getTaskInfo(taskId) {
    const task = scheduledTasks.get(taskId);
    return task ? Object.assign(Object.assign({}, task), { isActive: true }) : null;
}
export function getAllTasks() {
    return Array.from(scheduledTasks.values()).map(task => (Object.assign(Object.assign({}, task), { isActive: true })));
}
