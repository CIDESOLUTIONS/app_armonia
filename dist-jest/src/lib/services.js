...
export const usePQRService = () => {
     ...
     */
    const getPQRs = useCallback((...args_1) => __awaiter(void 0, [...args_1], void 0, function* (filters = {}) {
        // Simular una llamada a la API
        yield new Promise(resolve => setTimeout(resolve, 500));
        const { page = 1, limit = 10, status = '', priority = '', type = '', search = '' } = filters;
        ...
        if (search) {
            ...
            filtered = filtered.filter(pqr => pqr.title.toLowerCase().includes(searchLower) ||
     ...
     */
    const getPQRById = useCallback((id) => __awaiter(void 0, void 0, void 0, function* () {
        // Simular una llamada a la API
        yield new Promise(resolve => setTimeout(resolve, 500));
     ...
     */
    const createPQR = useCallback((data) => __awaiter(void 0, void 0, void 0, function* () {
        // Simular una llamada a la API
     ...
     */
    const updatePQR = useCallback((id, data) => __awaiter(void 0, void 0, void 0, function* () {
        // Simular una llamada a la API
        yield new Promise(resolve => setTimeout(resolve, 800));
        // Buscar el PQR
        ...
        // Actualizar el PQR
        const now = new Date().toISOString();
        const updatedPQR = Object.assign(Object.assign(Object.assign({}, MOCK_PQRS[index]), data), { updatedAt: now });
