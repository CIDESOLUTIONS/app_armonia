 ...
 */
export function runCommunicationsTests() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const notification = yield notifyUser(testUserId, {
                type: 'info',
            ...
            const readNotification = yield markNotificationAsRead(notification.id, testUserId);
            ...
            const confirmationNotification = yield notifyUser(testUserId, {
                type: 'warning',
            ...
            const confirmedNotification = yield confirmNotificationReading(confirmationNotification.id, testUserId);
            ...
            const roleNotifications = yield notifyByRole('resident', {
                type: 'info',
            ...
            const events = yield prisma.communityEvent.findMany({
                where: {
                    startDate: {
                        gte: now,
                        lte: nextMonth
...
export function validateCommunicationsIntegration() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // Notificaciones API
            try {
                yield fetch('/api/communications/notifications');
            ...
            // Anuncios API
            try {
                yield fetch('/api/communications/announcements');
            ...
            // Eventos API
            try {
                yield fetch('/api/communications/events');
