 ...
 */
export function sendEmail(options_1) {
 ...
 * @returns Resultado del envío
 */
export function sendPasswordResetEmail(user, resetToken, schemaName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 * @returns Resultado del envío
 */
export function sendPQRUpdateNotification(pqr, user, schemaName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 * @returns Resultado del envío
 */
export function sendAssemblyInvitation(assembly, user, schemaName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 * @returns Resultado del envío
 */
export function sendEmailWithAttachments(options, attachments) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const emailOptions = Object.assign(Object.assign({}, options), { attachments: attachments.map(attachment => {
            ...
            return yield sendEmail(emailOptions);
        }
        catch (error) {
