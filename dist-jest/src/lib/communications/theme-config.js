...
export function getThemeConfig() {
    ...
    return {
        colors: {
            light: Object.assign(Object.assign({}, defaultTheme.colors.light), (((_a = customTheme.colors) === null || _a === void 0 ? void 0 : _a.light) || {})),
            dark: Object.assign(Object.assign({}, defaultTheme.colors.dark), (((_b = customTheme.colors) === null || _b === void 0 ? void 0 : _b.dark) || {})),
        },
 ...
 */
export function getNotificationColor(type, mode = 'light') {
 ...
 */
export function getNotificationBackgroundClass(type) {
    switch (type) {
        case 'info':
 ...
 */
export function getNotificationTextClass(type) {
    switch (type) {
        case 'info':
 ...
 */
export function getNotificationBorderClass(type) {
    switch (type) {
        case 'info':
 ...
 */
export function translate(key, language = 'Español') {
    var _a;
    const translations = {
        // Notificaciones
        'notifications': {
    ...
    return ((_a = translations[key]) === null || _a === void 0 ? void 0 : _a[language]) || key;
}
