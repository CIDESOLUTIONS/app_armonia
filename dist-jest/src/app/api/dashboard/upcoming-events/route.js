...
export function GET(req) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const upcomingAssemblies = yield tenantPrisma.assembly.findMany({
                where: {
                    date: {
                        gte: today,
                        lte: oneMonthLater,
            ...
            const upcomingFees = yield tenantPrisma.fee.findMany({
                where: {
                    isActive: true,
                },
                select: {
            ...
            return NextResponse.json({ message: 'Error al obtener próximos eventos', error: error.message }, { status: 500 });
        }
    });
}
