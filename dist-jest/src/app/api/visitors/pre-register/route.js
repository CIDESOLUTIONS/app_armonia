...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = yield preRegistrationService.getAllPreRegistrations({
                page,
                limit,
                status,
                residentId,
            ...
            return NextResponse.json({ error: 'Error al obtener pre-registros', message: error.message }, { status: 500 });
        }
    });
}
/**
...
export function POST(request) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Crear pre-registro
            const result = yield preRegistrationService.createPreRegistration(sanitizedData);
            ...
            return NextResponse.json({ error: 'Error al crear pre-registro', message: error.message }, { status: 400 });
        }
    });
}
