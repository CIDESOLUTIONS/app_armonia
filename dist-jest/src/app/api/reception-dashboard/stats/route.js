...
export function GET(req) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // KPIs
            const [visitorsToday, pendingPackages, activeIncidents, securityAlerts, commonAreasInUse, digitalLogsToday] = yield Promise.all([
            ...
            return NextResponse.json({ message: 'Error al obtener datos del dashboard de recepción', error: error.message }, { status: 500 });
        }
    });
}
