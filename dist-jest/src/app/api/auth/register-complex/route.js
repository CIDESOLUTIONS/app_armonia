...
export function POST(req) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const hashedPassword = yield bcrypt.hash(validatedData.adminPassword, 10);
            const complexCountResult = yield prisma.residentialComplex.count();
