...
export function POST(request) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const enrichedData = Object.assign(Object.assign({}, data), { complexId: payload.complexId, senderName: payload.name || payload.email, timestamp: new Date().toISOString() });
            // Enviar notificación por plantilla
            const result = yield pushNotificationService.sendTemplateNotification(type, enrichedData, notificationTarget);
            if (!result.success) {
                return NextResponse.json({
 ...
 */
function checkTemplatePermissions(type, userRole) {
    const permissions = {
