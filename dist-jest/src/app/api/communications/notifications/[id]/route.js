...
export function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function* (request, { params }) {
        try {
            ...
            const notification = yield notificationService.getNotifications(payload.id, payload.complexId, { id: notificationId });
...
export function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function* (request, { params }) {
        try {
            ...
            const notificationService = new NotificationService(payload.schemaName);
            const updatedNotification = yield notificationService.markAsRead(notificationId);
...
export function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function* (request, { params }) {
        try {
            ...
            const notificationService = new NotificationService(payload.schemaName);
            yield notificationService.deleteNotification(notificationId);
