...
export function POST(req_1, _a) {
    return __awaiter(this, arguments, void 0, function* (req, { params }) {
        try {
            ...
            if (camera.type !== 'PTZ') {
                return NextResponse.json({ error: 'Esta cámara no soporta control PTZ' }, { status: 400 });
            }
            ...
            if (payload.role !== 'ADMIN') {
                ...
                if (!permission) {
                    return NextResponse.json({ error: 'No tiene permiso para controlar esta cámara' }, { status: 403 });
                }
            }
