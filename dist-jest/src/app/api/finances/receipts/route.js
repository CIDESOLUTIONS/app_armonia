...
import { GetReceiptsSchema, CreateReceiptSchema } from '@/validators/finances/receipts.validator';
/**
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (validatedParams.page)
                filters.page = validatedParams.page;
            if (validatedParams.limit)
                filters.limit = validatedParams.limit;
            // Obtener recibos
            const receipts = yield financialService.getReceipts(filters);
 ...
 */
function createReceiptHandler(validatedData, req) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Verificar autenticación
            const session = yield getServerSession(authOptions);
            ...
            const receipt = yield financialService.generateReceipt({
