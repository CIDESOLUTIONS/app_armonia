...
export default function ServiceUsageReportsPage() {
    ...
    return (_jsxs("div", { className: "container mx-auto p-6", children: [_jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-6", children: "Reportes de Uso de Servicios" }), _jsxs("div", { className: "bg-white shadow-md rounded-lg p-6", children: [_jsx("h2", { className: "text-xl font-semibold mb-4", children: "Generar Nuevo Reporte de Uso de Servicios" }), _jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [_jsxs("div", { children: [_jsx(Label, { htmlFor: "reportType", children: "Tipo de Reporte" }), _jsxs(Select, { value: reportType, onValueChange: setReportType, children: [_jsx(SelectTrigger, { id: "reportType", children: _jsx(SelectValue, { placeholder: "Seleccionar tipo de reporte" }) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "common_area_occupancy", children: "Ocupaci\u00F3n de \u00C1reas Comunes" }), _jsx(SelectItem, { value: "reservation_frequency", children: "Frecuencia de Reservas" }), _jsx(SelectItem, { value: "service_revenue", children: "Ingresos por Servicios" })] })] })] }), _jsxs("div", { children: [_jsx(Label, { htmlFor: "startDate", children: "Fecha de Inicio" }), _jsx(Input, { id: "startDate", type: "date", value: startDate, onChange: (e) => setStartDate(e.target.value) })] }), _jsxs("div", { children: [_jsx(Label, { htmlFor: "endDate", children: "Fecha de Fin" }), _jsx(Input, { id: "endDate", type: "date", value: endDate, onChange: (e) => setEndDate(e.target.value) })] }), _jsx("div", { className: "md:col-span-2 flex justify-end", children: _jsxs(Button, { type: "submit", onClick: handleGenerateReport, disabled: loading, children: [loading ? _jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }) : _jsx(Download, { className: "mr-2 h-4 w-4" }), " Generar Reporte"] }) })] })] }), _jsxs("div", { className: "mt-8 bg-white shadow-md rounded-lg p-6", children: [_jsx("h2", { className: "text-xl font-semibold mb-4", children: "Historial de Reportes Generados (Pr\u00F3ximamente)" }), _jsx("p", { className: "text-gray-600", children: "Aqu\u00ED se mostrar\u00E1 un historial de los reportes de uso de servicios generados previamente." })] })] }));
}
