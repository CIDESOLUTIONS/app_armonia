...
export default class CameraService {
    ...
    getCameras() {
        return __awaiter(this, arguments, void 0, function* (includeInactive = false) {
            try {
                ...
                return yield this.prisma.camera.findMany({
                    where,
                    orderBy: [
                        { name: 'asc' }
                    ],
    ...
    getCameraById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const camera = yield this.prisma.camera.findUnique({
                    where: { id },
                    include: {
                        zone: {
                            select: {
                ...
                if (camera.password) {
                    camera.password = yield decryptData(camera.password);
                }
                return camera;
            }
            catch (error) {
     ...
     */
    createCamera(data, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Validar datos de la cámara
                this.validateCameraData(data);
                // Encriptar contraseña si existe
                let cameraData = Object.assign({}, data);
                if (cameraData.password) {
                    cameraData.password = yield encryptData(cameraData.password);
                }
                ...
                // Crear la cámara
                const camera = yield this.prisma.camera.create({
                    data: Object.assign(Object.assign({}, cameraData), { createdById: userId })
                });
                // Registrar actividad
                yield this.activityLogger.logActivity({
                    userId,
     ...
     */
    updateCamera(id, data, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Verificar que la cámara existe
                const existingCamera = yield this.prisma.camera.findUnique({
                    where: { id }
                });
                if (!existingCamera) {
                    throw new Error(`Cámara con ID ${id} no encontrada`);
                ...
                const camera = yield this.prisma.camera.update({
                    where: { id },
                    data: cameraData
                });
                // Registrar actividad
     ...
     * @returns Cámara actualizada
     */
    toggleCameraActive(id, isActive, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Verificar que la cámara existe
                const existingCamera = yield this.prisma.camera.findUnique({
    ...
    checkCameraStatus(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const camera = yield this.getCameraById(id);
                let status = 'OFFLINE';
                ...
                if (camera.onvifUrl) {
                    ...
                    try {
                        ...
                        yield device.init();
                        const deviceInfo = yield device.fetchDeviceInformation();
                        status = 'ONLINE';
                        statusDetails = {
                ...
                if (status === 'OFFLINE' && camera.httpUrl) {
                    // Intentar ping HTTP
                    try {
                        const response = yield axios.get(camera.httpUrl, {
                ...
                const updatedCamera = yield this.prisma.camera.update({
                    where: { id },
                    data: Object.assign({ status, lastStatusCheck: new Date() }, (statusDetails && {
     ...
     */
    getCameraStream(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, quality = 'medium') {
            try {
                // Obtener datos de la cámara
                const camera = yield this.getCameraById(id);
                if (!camera.isActive) {
                ...
                if (camera.status !== 'ONLINE') {
                    ...
                    const updatedCamera = yield this.checkCameraStatus(id);
     ...
     */
    takeSnapshot(id, userId, description) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Obtener datos de la cámara
                const camera = yield this.getCameraById(id);
                ...
                yield this.captureSnapshot(camera.rtspUrl, filePath, camera.username, camera.password);
                // Registrar en la base de datos
                const snapshot = yield this.prisma.snapshot.create({
                    data: {
                        cameraId: id,
                        timestamp,
                        filePath,
     ...
     */
    startRecording(id, userId, duration) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Obtener datos de la cámara
                const camera = yield this.getCameraById(id);
                ...
                const activeRecording = yield this.prisma.recording.findFirst({
                    where: {
                        cameraId: id,
                        status: 'RECORDING'
                    }
                ...
                const recording = yield this.prisma.recording.create({
                    data: {
                        cameraId: id,
                        startTime,
                        filePath,
    ...
    stopRecording(id, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const recording = yield this.prisma.recording.update({
    ...
    getCameraSnapshots(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, filters = {}) {
            try {
                ...
                const [snapshots, total] = yield Promise.all([
    ...
    discoverCameras() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const devices = yield OnvifDevice.discoverDevices();
     ...
     * @returns Resultado de la operación
     */
    updateCameraPermissions(id, permissions, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Verificar que la cámara existe
                const camera = yield this.prisma.camera.findUnique({
                ...
                yield this.prisma.cameraPermission.deleteMany({
                    where: { cameraId: id }
                });
                // Crear nuevos permisos
                const createdPermissions = yield Promise.all(permissions.map((perm) => __awaiter(this, void 0, void 0, function* () {
     ...
     */
    checkUserPermission(cameraId, userId, permission) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                // Obtener cámara
                ...
                if (permission === 'view' && ((_a = camera.zone) === null || _a === void 0 ? void 0 : _a.isPublic)) {
                    return true;
                }
                // Obtener usuario
                ...
                const userPermission = yield this.prisma.cameraPermission.findUnique({
                    where: {
                        cameraId_userId: {
                            cameraId,
                            userId
                ...
                const now = new Date();
                if ((userPermission.startTime && userPermission.startTime > now) ||
     ...
     * @returns Resultado de la operación
     */
    controlCamera(id, action, params, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Verificar permiso
                const hasPermission = yield this.checkUserPermission(id, userId, 'control');
                if (!hasPermission) {
                ...
                switch (action) {
                    ...
                    case 'preset':
                        ...
                        if (params.presetToken) {
                            result = yield device.ptzGotoPreset({
     ...
     */
    captureSnapshot(rtspUrl, outputPath, username, password) {
     ...
     * @param duration Duración en segundos (opcional)
     */
    recordCamera(camera, outputPath, recordingId, duration) {
        // Construir comando FFmpeg
        let ffmpegArgs = [
            '-y', // Sobrescribir archivo si existe
            '-rtsp_transport', 'tcp', // Usar TCP para RTSP
        ...
        ffmpeg.on('close', (code) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (code === 0) {
                    // Grabación exitosa
                    yield this.prisma.recording.update({
        ...
        // Manejar errores
        ffmpeg.on('error', (err) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.prisma.recording.update({
                    where: { id: recordingId },
                    data: {
