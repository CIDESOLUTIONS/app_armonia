    ...
    getAllRules() {
        return __awaiter(this, arguments, void 0, function* (options = {}) {
            try {
                ...
                const rules = yield this.prisma.invoiceRule.findMany({
                    where,
                    skip,
                    take,
                    orderBy: {
    ...
    getRuleById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const rule = yield this.prisma.invoiceRule.findUnique({
                    where: { id },
                });
                if (!rule) {
    ...
    createRule(ruleData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const rule = yield this.prisma.invoiceRule.create({
                    data: {
                        name: ruleData.name,
    ...
    updateRule(id, ruleData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingRule = yield this.prisma.invoiceRule.findUnique({
                    where: { id },
                });
                if (!existingRule) {
                ...
                const updatedRule = yield this.prisma.invoiceRule.update({
                    where: { id },
                    data: Object.assign(Object.assign({}, ruleData), { updatedAt: new Date() }),
                });
    ...
    deleteRule(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.prisma.invoiceRule.delete({
                    where: { id },
                });
    ...
    evaluateRule(ruleId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const rule = yield this.getRuleById(ruleId);
                if (!rule) {
                ...
                try {
                    const context = Object.assign(Object.assign({}, rule.parameters), data);
