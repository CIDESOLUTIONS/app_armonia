...
export class AssemblyAdvancedService {
    ...
    createAssembly(data, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Registrar actividad
                yield activityLogger.logActivity({
                    userId,
                ...
                yield notifyAssemblyConvocation(assembly.id, assembly.title, assembly.date, assembly.location);
                return assembly;
            }
            catch (error) {
     ...
     */
    registerAttendance(assemblyId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingAttendance = yield prisma.assemblyAttendee.findFirst({
                    where: {
                        assemblyId,
                ...
                const attendance = yield prisma.assemblyAttendee.create({
                    data: {
                        assemblyId,
                        userId: data.userId,
                        propertyUnitId: data.propertyUnitId,
                ...
                yield this.updateQuorum(assemblyId);
                // Registrar actividad
                yield activityLogger.logActivity({
                    userId: data.userId,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (quorumReached && (!assembly.quorumReachedAt || assembly.quorumStatus !== 'REACHED')) {
                    ...
                    yield notifyQuorumReached(assemblyId, quorumPercentage);
                    // Notificar por WebSocket
                    yield wsService.broadcast(assembly.realtimeChannel, {
                        type: 'QUORUM_REACHED',
                        data: {
                            assemblyId,
                            currentCoefficient: totalCoefficient,
     ...
     */
    startAssembly(assemblyId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Verificar si la asamblea existe y está en estado válido
                const assembly = yield prisma.assembly.findUnique({
    ...
    createVoting(data, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Crear la votación
                const voting = yield prisma.voting.create({
                    data: {
     ...
     */
    startVoting(votingId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Verificar si la votación existe y está en estado válido
                const voting = yield prisma.voting.findUnique({
                    where: { id: votingId },
                ...
                const updatedVoting = yield prisma.voting.update({
                    where: { id: votingId },
                    data: {
                        status: 'ACTIVE',
                        startTime: new Date()
                ...
                // Notificar por WebSocket
                yield wsService.broadcast(voting.assembly.realtimeChannel, {
                    type: 'VOTING_STARTED',
                    data: {
                        votingId,
                ...
                yield notifyVotingOpened(voting.assemblyId, voting.agendaPoint, voting.title);
                // Registrar actividad
                yield activityLogger.logActivity({
                    userId,
                    action: 'START_VOTING',
    ...
    castVote(data, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const attendee = yield prisma.assemblyAttendee.findUnique({
                ...
                yield this.updateVotingCounters(data.votingId);
    ...
    closeVoting(votingId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const counters = yield this.updateVotingCounters(votingId);
                ...
                if (counters.result['Sí'] && counters.result['No']) {
                    ...
                    yield notifyVotingClosed(voting.assemblyId, voting.agendaPoint, voting.title, {
                        yesVotes,
                        noVotes,
                        yesPercentage,
                        noPercentage,
                ...
                return Object.assign(Object.assign({}, updatedVoting), { result: counters.result });
            }
            catch (error) {
    ...
    endAssembly(assemblyId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const activeVotings = yield prisma.voting.count({
                    where: {
                        assemblyId,
                        status: 'ACTIVE'
                    }
                ...
                // Enviar notificaciones
                yield notifyAssemblyEnded(assemblyId, assembly.title);
                // Iniciar generación de acta
                yield this.initializeMinutes(assemblyId, userId);
                // Registrar actividad
                yield activityLogger.logActivity({
                    userId,
                    action: 'END_ASSEMBLY',
     ...
     */
    initializeMinutes(assemblyId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingMinutes = yield prisma.assemblyMinutes.findUnique({
                    where: { assemblyId }
                });
                if (existingMinutes) {
                ...
                const minutes = yield prisma.assemblyMinutes.create({
                    data: {
                        assemblyId,
                        status: 'GENERATING',
     ...
     * @param userId ID del usuario que inicia la generación
     */
    generateMinutesContent(minutesId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Obtener información del acta
                const minutes = yield prisma.assemblyMinutes.findUnique({
                    where: { id: minutesId },
                    include: { assembly: true }
                });
                if (!minutes) {
                ...
                const votings = yield prisma.voting.findMany({
                    where: { assemblyId: minutes.assemblyId }
                });
                    ...
                    if (pointVotings.length > 0) {
                        ...
                        pointVotings.forEach(voting => {
                            ...
                            if (voting.status === 'CLOSED') {
                                ...
                                const result = voting.result;
                                if (result) {
                                    content += `| Opción | Votos | Coeficiente |\n`;
                                    content += `|--------|-------|-------------|\n`;
                                    Object.entries(result).forEach(([option, data]) => {
                ...
                yield prisma.assemblyMinutes.update({
                    where: { id: minutesId },
                    data: {
                        content,
                        status: 'GENERATED',
                ...
                // Generar PDF
                const pdfResult = yield this.generateMinutesPdf(minutesId);
                // Registrar actividad
                yield activityLogger.logActivity({
                    userId,
                ...
                yield notifyMinutesAvailable(minutes.assemblyId, assembly.title);
     ...
     */
    registerRequiredSigners(minutesId, signers, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (const signer of signers) {
                    const signature = yield prisma.digitalSignature.create({
                        data: {
                            minutesId,
     ...
     */
    signMinutes(signatureId, userId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Verificar si la firma existe
                const signature = yield prisma.digitalSignature.findUnique({
                ...
                const signatureData = yield signatureService.generateSignature({
                ...
                // Actualizar firma
                const updatedSignature = yield prisma.digitalSignature.update({
                    where: { id: signatureId },
                    data: {
                        status: 'SIGNED',
                        signedAt: new Date(),
                ...
                const minutes = yield prisma.assemblyMinutes.update({
                ...
                if (minutes.signaturesCompleted >= minutes.signaturesRequired) {
                    yield this.finalizeSignedMinutes(signature.minutesId, userId);
                }
                // Registrar actividad
                yield activityLogger.logActivity({
                    userId,
     ...
     */
    finalizeSignedMinutes(minutesId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Obtener información del acta
                const minutes = yield prisma.assemblyMinutes.findUnique({
                ...
                const signedPdfUrl = yield signatureService.generateSignedPdf(minutes.pdfUrl, minutes.signatures.map(s => ({
                    id: s.id,
                    name: s.signerName,
                    role: s.signerRole,
                ...
                // Actualizar acta
                const updatedMinutes = yield prisma.assemblyMinutes.update({
                    where: { id: minutesId },
                    data: {
                        status: 'SIGNED',
                        signedPdfUrl
                ...
                // Notificar por WebSocket
                yield wsService.broadcast(`assembly-${minutes.assemblyId}`, {
                    type: 'MINUTES_SIGNED',
                    data: {
                        assemblyId: minutes.assemblyId,
                        minutesId,
