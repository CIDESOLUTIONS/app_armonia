...
describe('PQR System Integration Tests', () => {
    ...
    describe('Flujo completo de PQR', () => {
        it('debe procesar un PQR desde creación hasta resolución', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const notificationResult = yield notificationService.notifyStatusChange(mockPQR.id, PQRStatus.ASSIGNED, PQRStatus.OPEN, 5, // adminId
    ...
    describe('Flujo de notificaciones y seguimiento', () => {
        ...
        it('debe enviar encuesta de satisfacción al resolver un PQR', () => __awaiter(void 0, void 0, void 0, function* () {
            // PQR resuelto
            prisma.pQR.findUnique.mockResolvedValueOnce({
                id: 123,
                ticketNumber: 'PQR-20250602-001',
