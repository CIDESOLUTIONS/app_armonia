...
describe('AssemblyAdvancedService', () => {
    ...
    describe('createAssembly', () => {
        it('debe crear una asamblea con configuración avanzada', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const assemblyData = {
            ...
            const mockAssembly = Object.assign(Object.assign({ id: 1 }, assemblyData), { status: 'SCHEDULED', currentCoefficient: 0, quorumStatus: 'NOT_REACHED', realtimeChannel: expect.any(String), createdBy: userId, createdAt: expect.any(Date), updatedAt: expect.any(Date) });
            prisma.assembly.create.mockResolvedValue(mockAssembly);
            // Ejecutar el método
            const result = yield service.createAssembly(assemblyData, userId);
            // Verificaciones
    ...
    describe('registerAttendance', () => {
        it('debe registrar asistencia y actualizar el quórum', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const assemblyId = 1;
            ...
            const mockAttendance = Object.assign(Object.assign({ id: 1, assemblyId }, attendanceData), { checkInTime: expect.any(Date) });
            const mockAttendees = [
            ...
            prisma.assembly.update.mockResolvedValue(Object.assign(Object.assign({}, mockAssembly), { currentCoefficient: 52.5, quorumStatus: 'NOT_REACHED' }));
            // Ejecutar el método
            const result = yield service.registerAttendance(assemblyId, attendanceData);
            // Verificaciones
        ...
        it('debe rechazar registro si la unidad ya está registrada', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const assemblyId = 1;
            const attendanceData = {
                userId: 123,
            ...
            yield expect(service.registerAttendance(assemblyId, attendanceData))
                .rejects
    ...
    describe('updateQuorum', () => {
        it('debe actualizar el quórum y notificar cuando se alcanza', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const assemblyId = 1;
            // Mock de respuestas de Prisma
            const mockAttendees = [
            ...
            const mockUpdatedAssembly = Object.assign(Object.assign({}, mockAssembly), { currentCoefficient: 75, quorumStatus: 'REACHED', quorumReachedAt: expect.any(Date) });
            prisma.assemblyAttendee.findMany.mockResolvedValue(mockAttendees);
            prisma.assembly.findUnique.mockResolvedValue(mockAssembly);
            prisma.assembly.update.mockResolvedValue(mockUpdatedAssembly);
            // Ejecutar el método
            const result = yield service.updateQuorum(assemblyId);
            // Verificaciones
            ...
            expect(wsService.broadcast).toHaveBeenCalledWith(mockAssembly.realtimeChannel, expect.objectContaining({
                type: 'QUORUM_REACHED'
            }));
    ...
    describe('startAssembly', () => {
        it('debe iniciar una asamblea cuando se ha alcanzado el quórum', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const assemblyId = 1;
            const userId = 123;
            // Mock de respuestas de Prisma
            ...
            const mockUpdatedAssembly = Object.assign(Object.assign({}, mockAssembly), { status: 'IN_PROGRESS' });
            prisma.assembly.findUnique.mockResolvedValue(mockAssembly);
            prisma.assembly.update.mockResolvedValue(mockUpdatedAssembly);
            // Ejecutar el método
            const result = yield service.startAssembly(assemblyId, userId);
            // Verificaciones
            expect(prisma.assembly.findUnique).toHaveBeenCalledWith({
                where: { id: assemblyId }
            });
        ...
        it('debe rechazar inicio si no se ha alcanzado el quórum', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const assemblyId = 1;
            const userId = 123;
            // Mock de respuestas de Prisma
            ...
            prisma.assembly.findUnique.mockResolvedValue(mockAssembly);
            // Ejecutar el método y verificar que lanza error
            yield expect(service.startAssembly(assemblyId, userId))
                .rejects
                .toThrow('No se puede iniciar la asamblea porque no se ha alcanzado el quórum requerido');
        }));
    });
    describe('createVoting', () => {
        it('debe crear una votación en una asamblea en progreso', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const votingData = {
                assemblyId: 1,
                agendaPoint: 2,
            ...
            const mockVoting = Object.assign(Object.assign({ id: 1 }, votingData), { status: 'PENDING', createdAt: expect.any(Date), updatedAt: expect.any(Date) });
            prisma.assembly.findUnique.mockResolvedValue(mockAssembly);
            prisma.voting.create.mockResolvedValue(mockVoting);
            // Ejecutar el método
            const result = yield service.createVoting(votingData, userId);
            // Verificaciones
            expect(prisma.assembly.findUnique).toHaveBeenCalledWith({
        ...
        it('debe rechazar creación si la asamblea no está en progreso', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const votingData = {
                assemblyId: 1,
                agendaPoint: 2,
            ...
            prisma.assembly.findUnique.mockResolvedValue(mockAssembly);
            // Ejecutar el método y verificar que lanza error
            yield expect(service.createVoting(votingData, userId))
                .rejects
                .toThrow(`No se puede crear una votación en una asamblea con estado ${mockAssembly.status}`);
        }));
    });
    describe('startVoting', () => {
        it('debe iniciar una votación pendiente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const votingId = 1;
            const userId = 123;
            // Mock de respuestas de Prisma
            ...
            const mockUpdatedVoting = Object.assign(Object.assign({}, mockVoting), { status: 'ACTIVE', startTime: expect.any(Date) });
            prisma.voting.findUnique.mockResolvedValue(mockVoting);
            prisma.voting.update.mockResolvedValue(mockUpdatedVoting);
            // Ejecutar el método
            const result = yield service.startVoting(votingId, userId);
            // Verificaciones
            ...
            expect(wsService.broadcast).toHaveBeenCalledWith(mockVoting.assembly.realtimeChannel, expect.objectContaining({
                type: 'VOTING_STARTED'
            }));
    ...
    describe('castVote', () => {
        it('debe registrar un voto válido', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const voteData = {
                votingId: 1,
                attendeeId: 10,
            ...
            const mockVote = Object.assign(Object.assign({ id: 1 }, voteData), { userId, coefficient: mockAttendee.coefficient, timestamp: expect.any(Date) });
            prisma.voting.findUnique.mockResolvedValue(mockVoting);
            ...
            // Ejecutar el método
            const result = yield service.castVote(voteData, userId);
            // Verificaciones
            expect(prisma.voting.findUnique).toHaveBeenCalledWith({
        ...
        it('debe rechazar voto si ya ha votado', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const voteData = {
                votingId: 1,
                attendeeId: 10,
            ...
            // Ejecutar el método y verificar que lanza error
            yield expect(service.castVote(voteData, userId))
                .rejects
                .toThrow('Ya ha emitido un voto en esta votación');
        }));
    });
    describe('closeVoting', () => {
        it('debe cerrar una votación activa y calcular resultados', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const votingId = 1;
            const userId = 123;
            // Mock de respuestas de Prisma
            ...
            const mockUpdatedVoting = Object.assign(Object.assign({}, mockVoting), { status: 'CLOSED', endTime: expect.any(Date), totalVotes: 3, totalCoefficientVoted: 75, result: expectedResult, isApproved: true });
            prisma.voting.findUnique.mockResolvedValue(mockVoting);
            prisma.vote.findMany.mockResolvedValue(mockVotes);
            prisma.voting.update.mockResolvedValue(mockUpdatedVoting);
            // Ejecutar el método
            const result = yield service.closeVoting(votingId, userId);
            // Verificaciones
            expect(prisma.voting.findUnique).toHaveBeenCalledWith({
                where: { id: votingId },
                include: { assembly: true }
            });
            expect(prisma.voting.update).toHaveBeenCalledWith(expect.objectContaining({
                where: { id: votingId },
                data: expect.objectContaining({
                    status: 'CLOSED',
    ...
    describe('endAssembly', () => {
        it('debe finalizar una asamblea en progreso', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const assemblyId = 1;
            const userId = 123;
            // Mock de respuestas de Prisma
            ...
            const mockUpdatedAssembly = Object.assign(Object.assign({}, mockAssembly), { status: 'COMPLETED', endTime: expect.any(Date) });
            prisma.assembly.findUnique.mockResolvedValue(mockAssembly);
            ...
            // Ejecutar el método
            const result = yield service.endAssembly(assemblyId, userId);
            // Verificaciones
            expect(prisma.assembly.findUnique).toHaveBeenCalledWith({
                where: { id: assemblyId }
            });
        ...
        it('debe rechazar finalización si hay votaciones activas', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const assemblyId = 1;
            const userId = 123;
            // Mock de respuestas de Prisma
            ...
            // Ejecutar el método y verificar que lanza error
            yield expect(service.endAssembly(assemblyId, userId))
                .rejects
