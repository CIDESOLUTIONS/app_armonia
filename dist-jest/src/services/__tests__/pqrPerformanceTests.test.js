...
jest.mock('@prisma/client', () => {
    const mockPrismaClient = {
        ...
        pQR: {
            ...
            create: jest.fn().mockImplementation((data) => Promise.resolve(Object.assign({ id: Math.floor(Math.random() * 1000) }, data.data))),
            update: jest.fn().mockImplementation((data) => Promise.resolve(Object.assign({ id: data.where.id }, data.data))),
...
describe('PQR System Performance Tests', () => {
    ...
    describe('Pruebas de rendimiento para operaciones individuales', () => {
        it('debe procesar un PQR dentro del tiempo máximo aceptable', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const pqrData = {
                type: 'COMPLAINT',
            ...
            const result = yield assignmentService.processPQR(pqrData);
        ...
        it('debe enviar notificaciones dentro del tiempo máximo aceptable', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const startTime = performance.now();
            const result = yield notificationService.notifyStatusChange(123, 'IN_PROGRESS', 'ASSIGNED', 10, 'Iniciando trabajo en la solicitud');
            const endTime = performance.now();
            const processingTime = endTime - startTime;
            // Verificar resultado
        ...
        it('debe generar métricas dentro del tiempo máximo aceptable', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const startTime = performance.now();
            const result = yield metricsService.generateDashboardMetrics();
            const endTime = performance.now();
            const processingTime = endTime - startTime;
            // Verificar resultado
            expect(result).toBeDefined();
    ...
    describe('Pruebas de carga para operaciones masivas', () => {
        it('debe manejar múltiples creaciones de PQR concurrentes', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const promises = Array.from({ length: TEST_CONFIG.numPQRs }, (_, i) => {
                const pqrData = Object.assign(Object.assign({}, basePqrData), { title: `${basePqrData.title} ${i + 1}`, unitId: 100 + i, unitNumber: `${100 + i}` });
        ...
        it('debe manejar múltiples notificaciones concurrentes', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para PQR
            ...
            const promises = Array.from({ length: TEST_CONFIG.numPQRs }, (_, i) => {
                ...
                return new Promise(resolve => {
                    setTimeout(() => {
                        resolve(notificationService.notifyStatusChange(pqrId, 'IN_PROGRESS', 'ASSIGNED', 10, `Iniciando trabajo en la solicitud ${pqrId}`));
        ...
        it('debe manejar múltiples consultas de métricas concurrentes con diferentes filtros', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mocks para métricas
    ...
    describe('Pruebas de estrés para límites del sistema', () => {
        it('debe manejar un pico de carga en creación de PQRs', () => __awaiter(void 0, void 0, void 0, function* () {
            // Aumentar el número de PQRs para prueba de estrés
            const stressTestConfig = Object.assign(Object.assign({}, TEST_CONFIG), { numPQRs: 500, creationInterval: 10 // Intervalo más corto para simular pico de carga
             });
            // Datos de prueba base
            const basePqrData = {
                type: 'COMPLAINT',
