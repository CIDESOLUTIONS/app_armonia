...
describe('InvoiceTemplateService', () => {
    ...
    describe('getTemplates', () => {
        it('debe devolver todas las plantillas activas cuando includeInactive es false', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock
            const mockTemplates = [
            ...
            // Ejecutar método
            const result = yield service.getTemplates();
            // Verificar resultado
        ...
        it('debe devolver todas las plantillas cuando includeInactive es true', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock
            const mockTemplates = [
                { id: 1, name: 'Plantilla 1', isActive: true },
            ...
            mockPrisma.invoiceTemplate.findMany.mockResolvedValue(mockTemplates);
            // Ejecutar método
            const result = yield service.getTemplates(true);
            // Verificar resultado
            expect(result).toEqual(mockTemplates);
            expect(mockPrisma.invoiceTemplate.findMany).toHaveBeenCalledWith({
                where: {},
        ...
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(service.getTemplates()).rejects.toThrow('Error al obtener plantillas');
            // Verificar que se registró el error
            expect(ServerLogger.error).toHaveBeenCalledWith('Error al obtener plantillas:', mockError);
        }));
    });
    describe('getTemplateById', () => {
        it('debe devolver una plantilla por ID', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock
            ...
            // Ejecutar método
            const result = yield service.getTemplateById(1);
            // Verificar resultado
        ...
        it('debe lanzar error si la plantilla no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para devolver null
            mockPrisma.invoiceTemplate.findUnique.mockResolvedValue(null);
            // Ejecutar método y verificar que lanza error
            yield expect(service.getTemplateById(999)).rejects.toThrow('Plantilla con ID 999 no encontrada');
        }));
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para lanzar error
            const mockError = new Error('Error de base de datos');
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.getTemplateById(1)).rejects.toThrow();
            // Verificar que se registró el error
            expect(ServerLogger.error).toHaveBeenCalledWith('Error al obtener plantilla con ID 1:', mockError);
        }));
    });
    describe('createTemplate', () => {
        it('debe crear una nueva plantilla', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const templateData = {
            ...
            const userId = 1;
            // Configurar mock
            const createdTemplate = Object.assign({ id: 1 }, templateData);
            mockPrisma.invoiceTemplate.create.mockResolvedValue(createdTemplate);
            // Ejecutar método
            const result = yield service.createTemplate(templateData, userId);
            // Verificar resultado
        ...
        it('debe validar los datos de la plantilla', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos incompletos
            const templateData = {
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.createTemplate(templateData, 1)).rejects.toThrow('El nombre de la plantilla es obligatorio');
        }));
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const templateData = {
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.createTemplate(templateData, 1)).rejects.toThrow();
            // Verificar que se registró el error
            expect(ServerLogger.error).toHaveBeenCalledWith('Error al crear plantilla:', mockError);
        }));
    });
    describe('updateTemplate', () => {
        it('debe actualizar una plantilla existente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const templateId = 1;
            const templateData = {
            ...
            const updatedTemplate = Object.assign({ id: templateId }, templateData);
            mockPrisma.invoiceTemplate.update.mockResolvedValue(updatedTemplate);
            // Ejecutar método
            const result = yield service.updateTemplate(templateId, templateData, userId);
            // Verificar resultado
        ...
        it('debe lanzar error si la plantilla no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            mockPrisma.invoiceTemplate.findUnique.mockResolvedValue(null);
            // Ejecutar método y verificar que lanza error
            yield expect(service.updateTemplate(999, {}, 1)).rejects.toThrow('Plantilla con ID 999 no encontrada');
        }));
        it('debe validar los datos de la plantilla', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para verificar existencia
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.updateTemplate(1, templateData, 1)).rejects.toThrow('El nombre de la plantilla es obligatorio');
        }));
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para verificar existencia
            mockPrisma.invoiceTemplate.findUnique.mockResolvedValue({ id: 1, name: 'Plantilla Original' });
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.updateTemplate(1, templateData, 1)).rejects.toThrow();
            // Verificar que se registró el error
            expect(ServerLogger.error).toHaveBeenCalledWith('Error al actualizar plantilla con ID 1:', mockError);
        }));
    });
    describe('deleteTemplate', () => {
        it('debe eliminar una plantilla existente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const templateId = 1;
            const userId = 1;
            // Configurar mock para verificar existencia
            ...
            // Ejecutar método
            const result = yield service.deleteTemplate(templateId, userId);
            // Verificar resultado
        ...
        it('debe lanzar error si la plantilla no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            mockPrisma.invoiceTemplate.findUnique.mockResolvedValue(null);
            // Ejecutar método y verificar que lanza error
            yield expect(service.deleteTemplate(999, 1)).rejects.toThrow('Plantilla con ID 999 no encontrada');
        }));
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para verificar existencia
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.deleteTemplate(1, 1)).rejects.toThrow();
            // Verificar que se registró el error
            expect(ServerLogger.error).toHaveBeenCalledWith('Error al eliminar plantilla con ID 1:', mockError);
        }));
    });
    describe('setDefaultTemplate', () => {
        it('debe establecer una plantilla como predeterminada', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const templateId = 1;
            const userId = 1;
            // Configurar mock para verificar existencia
            ...
            // Ejecutar método
            const result = yield service.setDefaultTemplate(templateId, userId);
            // Verificar resultado
        ...
        it('debe lanzar error si la plantilla no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            mockPrisma.invoiceTemplate.findUnique.mockResolvedValue(null);
            // Ejecutar método y verificar que lanza error
            yield expect(service.setDefaultTemplate(999, 1)).rejects.toThrow('Plantilla con ID 999 no encontrada');
        }));
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para verificar existencia
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.setDefaultTemplate(1, 1)).rejects.toThrow();
            // Verificar que se registró el error
    ...
    describe('renderInvoice', () => {
        it('debe renderizar una factura con la plantilla especificada', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const invoiceId = 1;
            const templateId = 2;
            ...
            // Ejecutar método
            const result = yield service.renderInvoice(invoiceId, templateId);
            // Verificar resultado
        ...
        it('debe usar la plantilla predeterminada si no se especifica templateId', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const invoiceId = 1;
            // Mock de datos de factura
            const mockInvoice = {
            ...
            // Ejecutar método
            yield service.renderInvoice(invoiceId);
        ...
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.renderInvoice(1, 2)).rejects.toThrow();
            // Verificar que se registró el error
