...
describe('PQRNotificationService - Pruebas Avanzadas', () => {
    ...
    describe('notifyStatusChange - Canales Múltiples', () => {
        it('debe enviar notificaciones por múltiples canales según preferencias del usuario', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para PQR
            ...
            // Ejecutar el método
            const result = yield service.notifyStatusChange(123, PQRStatus.IN_PROGRESS, PQRStatus.ASSIGNED, 10, 'Iniciando trabajo en la solicitud');
            // Verificar resultado
        ...
        it('debe respetar horarios de no molestar para notificaciones', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('debe enviar notificaciones de alta prioridad incluso en horario de no molestar', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar fecha actual para simular horario nocturno
            const nightTime = new Date('2025-06-02T23:30:00');
            jest.spyOn(global, 'Date').mockImplementation(() => nightTime);
            ...
            // Ejecutar el método
            const result = yield service.notifyStatusChange(123, PQRStatus.ASSIGNED, PQRStatus.OPEN, 10, 'Asignando técnico para atender urgencia');
            // Verificar resultado
            expect(result).toBe(true);
    ...
    describe('sendDueDateReminders - Escenarios Avanzados', () => {
        it('debe enviar recordatorios escalonados según proximidad a la fecha límite', () => __awaiter(void 0, void 0, void 0, function* () {
            // Fecha actual
            const now = new Date();
            ...
            // Ejecutar el método
            const reminderCount = yield service.sendDueDateReminders();
            // Verificar resultado
            ...
            const urgentCall = emailCalls.find(call => call[0].subject.includes('URGENTE') ||
                call[0].text.includes('URGENTE'));
            expect(urgentCall).toBeTruthy();
        }));
        it('debe escalar notificaciones para PQRs con SLA incumplido', () => __awaiter(void 0, void 0, void 0, function* () {
            // Fecha actual
            const now = new Date();
            // Fecha vencida
            ...
            // Ejecutar el método
            const escalationCount = yield service.escalateBreachedSLA();
            // Verificar resultado
    ...
    describe('sendSatisfactionSurvey - Personalización', () => {
        it('debe enviar encuesta personalizada según tipo y categoría de PQR', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            const result = yield service.sendSatisfactionSurvey(123);
            // Verificar resultado
            expect(result).toBe(true);
        ...
        it('debe programar recordatorio si la encuesta no se completa', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para PQR resuelto
            prisma.pQR.findUnique.mockResolvedValue({
                id: 123,
                ticketNumber: 'PQR-20250602-001',
            ...
            const reminderCount = yield service.sendSurveyReminders();
            // Verificar resultado
            ...
            const reminderCount2 = yield service.sendSurveyReminders();
            // Verificar resultado
    ...
    describe('getNotificationTemplate - Personalización Avanzada', () => {
        it('debe aplicar variables complejas en plantillas personalizadas', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        `
            ...
            // Ejecutar el método
            const template = yield service.getNotificationTemplate(PQRStatus.RESOLVED, PQRStatus.IN_PROGRESS);
            // Verificar resultado
            ...
            const processedContent = yield service.processTemplateVariables(template.content, {
                ticketNumber: 'PQR-20250602-001',
    ...
    describe('Manejo de Errores Avanzado', () => {
        it('debe reintentar envío de notificaciones fallidas', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para PQR
            prisma.pQR.findUnique.mockResolvedValue({
                id: 123,
                ticketNumber: 'PQR-20250602-001',
            ...
            sendEmail.mockRejectedValueOnce(new Error('Error de servidor SMTP'));
            // Configurar mock para log de errores
            const consoleSpy = jest.spyOn(console, 'error').mockImplementation();
            // Ejecutar el método
            const result = yield service.notifyStatusChange(123, PQRStatus.IN_PROGRESS, PQRStatus.ASSIGNED, 10);
            // Verificar resultado
        ...
        it('debe manejar errores en la obtención de plantillas', () => __awaiter(void 0, void 0, void 0, function* () {
