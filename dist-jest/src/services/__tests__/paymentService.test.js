...
describe('PaymentService', () => {
    ...
    describe('createTransaction', () => {
        it('debe crear una transacción con datos válidos', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            ...
            const mockTransaction = Object.assign(Object.assign({ id: 1 }, transactionData), { status: 'PENDING', createdAt: new Date(), updatedAt: new Date() });
            ...
            // Ejecutar el método
            const result = yield PaymentService.createTransaction(transactionData);
            // Verificaciones
        ...
        it('debe rechazar transacción si el método de pago no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const transactionData = {
                amount: 100000,
                description: 'Pago de administración',
            ...
            yield expect(PaymentService.createTransaction(transactionData))
                .rejects
                .toThrow('Método de pago no encontrado');
        }));
        it('debe rechazar transacción si la pasarela no está activa', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const transactionData = {
                amount: 100000,
                description: 'Pago de administración',
    ...
    describe('processTransaction', () => {
        it('debe procesar una transacción pendiente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            ...
            const mockUpdatedTransaction = Object.assign(Object.assign({}, mockTransaction), { status: 'PROCESSING', gatewayReference: 'ref-123', updatedAt: new Date() });
            ...
            jest.spyOn(PaymentService, 'getGatewayAdapter').mockReturnValue({
            ...
            // Ejecutar el método
            const result = yield PaymentService.processTransaction(transactionId);
            // Verificaciones
        ...
        it('debe rechazar procesamiento si la transacción no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const transactionId = 999; // ID inexistente
            // Mock de respuestas de Prisma
            prisma.transaction.findUnique.mockResolvedValue(null);
            // Ejecutar el método y verificar que lanza error
            yield expect(PaymentService.processTransaction(transactionId))
                .rejects
                .toThrow('Transacción no encontrada');
        }));
        it('debe rechazar procesamiento si la transacción no está pendiente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const transactionId = 1;
            // Mock de respuestas de Prisma
            const mockTransaction = {
    ...
    describe('processWebhook', () => {
        it('debe procesar un webhook de pago exitoso', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const webhookData = {
                gateway: 'payu',
                body: {
            ...
            // Ejecutar el método
            const result = yield PaymentService.processWebhook(webhookData.gateway, webhookData.body, webhookData.headers['x-signature']);
            // Verificaciones
        ...
        it('debe rechazar webhook con firma inválida', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const webhookData = {
                gateway: 'payu',
                body: {
            ...
            // Ejecutar el método y verificar que lanza error
            yield expect(PaymentService.processWebhook(webhookData.gateway, webhookData.body, webhookData.headers['x-signature']))
                .rejects
                .toThrow('Firma de webhook inválida');
        }));
    });
    describe('getTransactions', () => {
        it('debe obtener transacciones con paginación', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const filters = {
                page: 1,
                limit: 10,
            ...
            // Ejecutar el método
            const result = yield PaymentService.getTransactions(filters);
            // Verificaciones
        ...
        it('debe filtrar transacciones por fecha', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            ...
            // Ejecutar el método
            yield PaymentService.getTransactions(filters);
            // Verificaciones
            expect(prisma.transaction.findMany).toHaveBeenCalledWith({
                where: {
                    createdAt: {
    ...
    describe('savePaymentToken', () => {
        it('debe guardar un token de pago', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const tokenData = {
                userId: 123,
                paymentMethodId: 1,
            ...
            // Mock de respuestas de Prisma
            const mockToken = Object.assign(Object.assign({ id: 1 }, tokenData), { token: 'encrypted_card_token_123', createdAt: new Date() });
            prisma.paymentToken.create.mockResolvedValue(mockToken);
            // Ejecutar el método
            const result = yield PaymentService.savePaymentToken(tokenData);
            // Verificaciones
            ...
            expect(result).toEqual(Object.assign(Object.assign({}, mockToken), { token: undefined // El token no debe ser devuelto
             }));
        }));
    });
});
