...
describe('CommunicationService', () => {
    ...
    describe('notifyUser', () => {
        it('should create a notification for a user', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock user exists
            ...
            const result = yield communicationService.notifyUser(1, {
                type: 'info',
                title: 'Test Notification',
                message: 'This is a test notification',
                sourceType: 'system'
        ...
        it('should throw an error if user does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(communicationService.notifyUser(999, {
                type: 'info',
                title: 'Test Notification',
                message: 'This is a test notification',
                sourceType: 'system'
    ...
    describe('getUserNotifications', () => {
        it('should return notifications for a user with filters', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock notifications
            ...
            // Call the service method
            const result = yield communicationService.getUserNotifications(1, {
                read: false,
                type: 'info'
            });
            // Assertions
    ...
    describe('markNotificationAsRead', () => {
        it('should mark a notification as read', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Call the service method
            const result = yield communicationService.markNotificationAsRead('notif-123', 1);
            // Assertions
        ...
        it('should throw an error if notification does not belong to user', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock notification does not exist or does not belong to user
            mockPrisma.notification.findFirst.mockResolvedValue(null);
            // Call the service method and expect it to throw
            yield expect(communicationService.markNotificationAsRead('notif-999', 1))
                .rejects.toThrow('Notificación no encontrada o no pertenece al usuario');
        }));
    });
    describe('getAnnouncements', () => {
        it('should return announcements for admin users', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock announcements
            ...
            // Call the service method
            const result = yield communicationService.getAnnouncements(1, 'admin');
            // Assertions
        ...
        it('should filter announcements for regular users', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock announcements
            const mockAnnouncements = [
                {
                    id: 'ann-1',
            ...
            mockPrisma.announcement.findMany.mockResolvedValue(mockAnnouncements);
            // Call the service method
            const result = yield communicationService.getAnnouncements(2, 'resident');
            // Assertions
            expect(mockPrisma.announcement.findMany).toHaveBeenCalledWith(expect.objectContaining({
                where: {
                    OR: [
                        { visibility: 'public' },
    ...
    describe('createAnnouncement', () => {
        it('should create an announcement with attachments', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const mockCompleteAnnouncement = Object.assign(Object.assign({}, mockAnnouncement), { createdBy: { id: 1, name: 'Admin' }, attachments: [
            ...
            // Call the service method
            const result = yield communicationService.createAnnouncement(1, {
                title: 'Test Announcement',
                content: 'This is a test announcement',
                attachments: [
    ...
    describe('markAnnouncementAsRead', () => {
        it('should mark an announcement as read', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Call the service method
            const result = yield communicationService.markAnnouncementAsRead('ann-123', 1);
            // Assertions
        ...
        it('should return existing read record if already read', () => __awaiter(void 0, void 0, void 0, function* () {
