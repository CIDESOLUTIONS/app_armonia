...
import MonitoringService, { MonitoringType, MonitoringStatus, AlertSeverity, AlertStatus } from '@/lib/services/monitoring-service';
...
describe('MonitoringService', () => {
    ...
    describe('createMonitoringConfig', () => {
        it('should create a monitoring configuration successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configData = {
                name: 'Test Config',
            ...
            const mockCreatedConfig = Object.assign(Object.assign({ id: 1 }, configData), { tenantId: 'test_tenant', isActive: true, createdAt: new Date(), updatedAt: new Date() });
            mockPrisma.monitoringConfig.create.mockResolvedValue(mockCreatedConfig);
            // Act
            const result = yield monitoringService.createMonitoringConfig(configData, 123);
            // Assert
        ...
        it('should handle errors when creating a monitoring configuration', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configData = {
                name: 'Test Config',
                monitoringType: MonitoringType.APPLICATION,
            ...
            // Act & Assert
            yield expect(monitoringService.createMonitoringConfig(configData, 123))
    ...
    describe('updateMonitoringConfig', () => {
        it('should update a monitoring configuration successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const updateData = {
                name: 'Updated Config',
            ...
            // Act
            const result = yield monitoringService.updateMonitoringConfig(configId, updateData, 123);
            // Assert
        ...
        it('should handle errors when updating a monitoring configuration', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const updateData = {
                name: 'Updated Config',
            ...
            // Act & Assert
            yield expect(monitoringService.updateMonitoringConfig(configId, updateData, 123))
                .rejects.toThrow('Error al actualizar configuración de monitoreo');
            expect(ServerLogger.error).toHaveBeenCalled();
        }));
    });
    describe('deleteMonitoringConfig', () => {
        it('should delete a monitoring configuration and related data successfully', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            ...
            // Act
            const result = yield monitoringService.deleteMonitoringConfig(configId, 123);
            // Assert
        ...
        it('should handle errors when deleting a monitoring configuration', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const mockError = new Error('Database error');
            mockPrisma.monitoringResult.deleteMany.mockRejectedValue(mockError);
            // Act & Assert
            yield expect(monitoringService.deleteMonitoringConfig(configId, 123))
                .rejects.toThrow('Error al eliminar configuración de monitoreo');
            expect(ServerLogger.error).toHaveBeenCalled();
        }));
    });
    describe('getMonitoringConfigs', () => {
        it('should get all active monitoring configurations', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const mockConfigs = [
                {
                    id: 1,
            ...
            // Act
            const result = yield monitoringService.getMonitoringConfigs();
            // Assert
        ...
        it('should include inactive configurations when specified', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const mockConfigs = [
                {
                    id: 1,
            ...
            mockPrisma.monitoringConfig.findMany.mockResolvedValue(mockConfigs);
            // Act
            const result = yield monitoringService.getMonitoringConfigs(true);
            // Assert
            expect(mockPrisma.monitoringConfig.findMany).toHaveBeenCalledWith({
                where: {
                    tenantId: 'test_tenant'
        ...
        it('should handle errors when getting monitoring configurations', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const mockError = new Error('Database error');
            mockPrisma.monitoringConfig.findMany.mockRejectedValue(mockError);
            // Act & Assert
            yield expect(monitoringService.getMonitoringConfigs())
                .rejects.toThrow('Error al obtener configuraciones de monitoreo');
            expect(ServerLogger.error).toHaveBeenCalled();
        }));
    });
    describe('executeCheck', () => {
        it('should execute a check for an application monitoring configuration', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const mockConfig = {
                id: configId,
            ...
            // Act
            const result = yield monitoringService.executeCheck(configId);
            // Assert
        ...
        it('should skip check for inactive configuration', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const mockConfig = {
                id: configId,
        ...
        it('should create an alert when check result exceeds thresholds', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const mockConfig = {
                id: configId,
        ...
        it('should handle errors during check execution', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const mockConfig = {
                id: configId,
            ...
            mockPrisma.monitoringResult.create.mockResolvedValue(mockResult);
            // Act
            yield expect(monitoringService.executeCheck(configId))
    ...
    describe('getActiveAlerts', () => {
        it('should get active alerts', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const mockAlerts = [
                {
                    id: 1,
            ...
            // Act
            const result = yield monitoringService.getActiveAlerts();
            // Assert
            expect(mockPrisma.alert.findMany).toHaveBeenCalledWith({
                where: {
        ...
        it('should include acknowledged alerts when specified', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const mockAlerts = [
                {
                    id: 1,
            ...
            mockPrisma.alert.findMany.mockResolvedValue(mockAlerts);
            // Act
            const result = yield monitoringService.getActiveAlerts(true);
            // Assert
            expect(mockPrisma.alert.findMany).toHaveBeenCalledWith({
                where: {
        ...
        it('should handle errors when getting active alerts', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const mockError = new Error('Database error');
            mockPrisma.alert.findMany.mockRejectedValue(mockError);
            // Act & Assert
            yield expect(monitoringService.getActiveAlerts())
                .rejects.toThrow('Error al obtener alertas');
            expect(ServerLogger.error).toHaveBeenCalled();
        }));
    });
    describe('acknowledgeAlert', () => {
        it('should acknowledge an alert', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const alertId = 1;
            const userId = 123;
            ...
            // Act
            const result = yield monitoringService.acknowledgeAlert(alertId, userId);
            // Assert
        ...
        it('should handle errors when acknowledging an alert', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const alertId = 1;
            const userId = 123;
            const mockError = new Error('Database error');
            ...
            // Act & Assert
            yield expect(monitoringService.acknowledgeAlert(alertId, userId))
                .rejects.toThrow('Error al reconocer alerta');
            expect(ServerLogger.error).toHaveBeenCalled();
        }));
    });
    describe('resolveAlert', () => {
        it('should resolve an alert', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const alertId = 1;
            const userId = 123;
            const mockUpdatedAlert = {
            ...
            mockPrisma.alert.update.mockResolvedValue(mockUpdatedAlert);
            // Act
            const result = yield monitoringService.resolveAlert(alertId, userId);
            // Assert
            expect(mockPrisma.alert.update).toHaveBeenCalledWith({
                where: { id: alertId },
                data: {
        ...
        it('should handle errors when resolving an alert', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const alertId = 1;
            const userId = 123;
            const mockError = new Error('Database error');
            mockPrisma.alert.update.mockRejectedValue(mockError);
            // Act & Assert
            yield expect(monitoringService.resolveAlert(alertId, userId))
                .rejects.toThrow('Error al resolver alerta');
            expect(ServerLogger.error).toHaveBeenCalled();
        }));
    });
    describe('getMonitoringStats', () => {
        it('should get monitoring statistics for a configuration', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const days = 7;
            const mockResults = [
            ...
            // Act
            const result = yield monitoringService.getMonitoringStats(configId, days);
            // Assert
        ...
        it('should handle empty results when getting statistics', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const days = 7;
        ...
        it('should handle errors when getting statistics', () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const configId = 1;
            const days = 7;
            const mockError = new Error('Database error');
            ...
            // Act & Assert
            yield expect(monitoringService.getMonitoringStats(configId, days))
