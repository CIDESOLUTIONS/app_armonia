...
describe('PQRAssignmentService - Pruebas Avanzadas', () => {
    ...
    describe('processPQR - Escenarios Complejos', () => {
        it('debe manejar reglas de asignación complejas con múltiples condiciones', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de entrada
            const pqrData = {
                type: 'COMPLAINT',
        ...
        it('debe manejar conflictos de asignación y seleccionar la regla más específica', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de entrada
            const pqrData = {
                type: 'COMPLAINT',
        ...
        it('debe manejar la reasignación automática cuando un PQR es reabierto', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('balanceWorkload', () => {
        it('debe distribuir la carga de trabajo equitativamente entre los miembros del equipo', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para equipo
            ...
            const result = yield service.balanceWorkload(5);
        ...
        it('debe considerar la prioridad y complejidad al balancear la carga', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para equipo
            prisma.pQRTeam.findUnique.mockResolvedValueOnce({
                id: 5,
                name: 'Equipo Mantenimiento',
            ...
            prisma.$queryRaw.mockImplementation((query, params) => {
                ...
                if (userId === 10)
                    return Promise.resolve([{ weighted_load: 6 }]);
                if (userId === 11)
                    return Promise.resolve([{ weighted_load: 5 }]);
                if (userId === 12)
                    return Promise.resolve([{ weighted_load: 3 }]);
                return Promise.resolve([{ weighted_load: 0 }]);
            });
            // Ejecutar el método con parámetros de complejidad
            const result = yield service.balanceWorkload(5, PQRPriority.HIGH, 'Complejo');
    ...
    describe('findSpecialist', () => {
        it('debe encontrar el especialista más adecuado según la categoría y subcategoría', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método (es privado, así que usamos any)
            const result = yield service.findSpecialist(PQRCategory.MAINTENANCE, 'Plomería', PQRPriority.HIGH);
        ...
        it('debe manejar el caso cuando no hay especialistas disponibles', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            const result = yield service.findSpecialist(PQRCategory.SECURITY, 'Alarmas', PQRPriority.URGENT);
    ...
    describe('calculateDueDate - Casos Avanzados', () => {
        it('debe respetar horarios laborales para categorías específicas', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            const result = yield service.calculateDueDate(PQRCategory.ADMINISTRATIVE, PQRPriority.MEDIUM);
            // Verificar resultado
        ...
        it('debe considerar días festivos en el cálculo de fechas límite', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('Manejo de Errores Avanzado', () => {
        it('debe manejar errores de base de datos durante la asignación', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de entrada
            const pqrData = {
                type: 'COMPLAINT',
        ...
        it('debe manejar errores durante la búsqueda de especialistas', () => __awaiter(void 0, void 0, void 0, function* () {
