...
describe('InvoiceRuleService', () => {
    ...
    describe('getRules', () => {
        it('debe devolver todas las reglas activas cuando includeInactive es false', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock
            const mockRules = [
            ...
            // Ejecutar método
            const result = yield service.getRules();
            // Verificar resultado
        ...
        it('debe devolver todas las reglas cuando includeInactive es true', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock
            const mockRules = [
                { id: 1, name: 'Regla 1', isActive: true },
            ...
            mockPrisma.invoiceRule.findMany.mockResolvedValue(mockRules);
            // Ejecutar método
            const result = yield service.getRules(true);
            // Verificar resultado
            expect(result).toEqual(mockRules);
            expect(mockPrisma.invoiceRule.findMany).toHaveBeenCalledWith({
                where: {},
        ...
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getRuleById', () => {
        ...
        it('debe lanzar error si la regla no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para devolver null
            mockPrisma.invoiceRule.findUnique.mockResolvedValue(null);
            // Ejecutar método y verificar que lanza error
            yield expect(service.getRuleById(999)).rejects.toThrow('Regla con ID 999 no encontrada');
        }));
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para lanzar error
            const mockError = new Error('Error de base de datos');
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.getRuleById(1)).rejects.toThrow();
            // Verificar que se registró el error
            expect(ServerLogger.error).toHaveBeenCalledWith('Error al obtener regla de facturación con ID 1:', mockError);
        }));
    });
    describe('createRule', () => {
        it('debe crear una nueva regla', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const ruleData = {
                name: 'Nueva Regla',
            ...
            const userId = 1;
            // Configurar mock
            const createdRule = Object.assign(Object.assign({ id: 1 }, ruleData), { nextRun: new Date() });
            mockPrisma.invoiceRule.create.mockResolvedValue(createdRule);
            // Ejecutar método
            const result = yield service.createRule(ruleData, userId);
            // Verificar resultado
            expect(result).toEqual(createdRule);
            expect(mockPrisma.invoiceRule.create).toHaveBeenCalledWith({
                data: expect.objectContaining(Object.assign(Object.assign({}, ruleData), { nextRun: expect.any(Date), createdById: userId }))
            });
        ...
        it('debe validar los datos de la regla', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos incompletos
            const ruleData = {
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.createRule(ruleData, 1)).rejects.toThrow('El nombre de la regla es obligatorio');
        }));
        it('debe calcular correctamente la próxima ejecución', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            mockPrisma.invoiceRule.create.mockImplementation((args) => {
                return Promise.resolve(Object.assign({ id: 1 }, args.data));
            });
            // Ejecutar método
            const result = yield service.createRule(ruleData, 1);
        ...
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.createRule(ruleData, 1)).rejects.toThrow();
            // Verificar que se registró el error
            expect(ServerLogger.error).toHaveBeenCalledWith('Error al crear regla de facturación:', mockError);
        }));
    });
    describe('updateRule', () => {
        it('debe actualizar una regla existente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const ruleId = 1;
            const ruleData = {
            ...
            const updatedRule = Object.assign(Object.assign({ id: ruleId }, ruleData), { nextRun: new Date() });
            mockPrisma.invoiceRule.update.mockResolvedValue(updatedRule);
            // Ejecutar método
            const result = yield service.updateRule(ruleId, ruleData, userId);
            // Verificar resultado
            expect(result).toEqual(updatedRule);
            expect(mockPrisma.invoiceRule.update).toHaveBeenCalledWith({
                where: { id: ruleId },
                data: expect.objectContaining(Object.assign(Object.assign({}, ruleData), { nextRun: expect.any(Date) }))
            });
            // Verificar que se registró la actividad
            expect(service.activityLogger.logActivity).toHaveBeenCalledWith({
                userId,
        ...
        it('debe lanzar error si la regla no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            mockPrisma.invoiceRule.findUnique.mockResolvedValue(null);
            // Ejecutar método y verificar que lanza error
            yield expect(service.updateRule(999, {}, 1)).rejects.toThrow('Regla con ID 999 no encontrada');
        }));
        it('debe validar los datos de la regla', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para verificar existencia
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.updateRule(1, ruleData, 1)).rejects.toThrow('El nombre de la regla es obligatorio');
        }));
        it('debe recalcular nextRun si cambian parámetros relevantes', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para verificar existencia
            const existingRule = {
                id: 1,
                name: 'Regla Original',
            ...
            mockPrisma.invoiceRule.update.mockImplementation((args) => {
                return Promise.resolve(Object.assign(Object.assign({ id: 1 }, existingRule), args.data));
            });
            // Ejecutar método
            const result = yield service.updateRule(1, ruleData, 1);
        ...
        it('debe mantener nextRun si no cambian parámetros relevantes', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para verificar existencia
            const existingRule = {
                id: 1,
                name: 'Regla Original',
        ...
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.updateRule(1, ruleData, 1)).rejects.toThrow();
            // Verificar que se registró el error
            expect(ServerLogger.error).toHaveBeenCalledWith('Error al actualizar regla de facturación con ID 1:', mockError);
        }));
    });
    describe('deleteRule', () => {
        it('debe eliminar una regla existente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const ruleId = 1;
            const userId = 1;
            // Configurar mock para verificar existencia
            ...
            // Ejecutar método
            const result = yield service.deleteRule(ruleId, userId);
            // Verificar resultado
        ...
        it('debe lanzar error si la regla no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            mockPrisma.invoiceRule.findUnique.mockResolvedValue(null);
            // Ejecutar método y verificar que lanza error
            yield expect(service.deleteRule(999, 1)).rejects.toThrow('Regla con ID 999 no encontrada');
        }));
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para verificar existencia
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.deleteRule(1, 1)).rejects.toThrow();
            // Verificar que se registró el error
    ...
    describe('toggleRuleActive', () => {
        it('debe activar una regla inactiva', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const ruleId = 1;
            const userId = 1;
            // Configurar mock para verificar existencia
            ...
            mockPrisma.invoiceRule.update.mockResolvedValue(updatedRule);
            // Ejecutar método
            const result = yield service.toggleRuleActive(ruleId, true, userId);
            // Verificar resultado
            expect(result).toEqual(updatedRule);
            expect(mockPrisma.invoiceRule.update).toHaveBeenCalledWith({
                where: { id: ruleId },
        ...
        it('debe desactivar una regla activa', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const ruleId = 1;
            const userId = 1;
            // Configurar mock para verificar existencia
            ...
            mockPrisma.invoiceRule.update.mockResolvedValue(updatedRule);
            // Ejecutar método
            const result = yield service.toggleRuleActive(ruleId, false, userId);
            // Verificar resultado
            expect(result).toEqual(updatedRule);
            expect(mockPrisma.invoiceRule.update).toHaveBeenCalledWith({
                where: { id: ruleId },
        ...
        it('debe lanzar error si la regla no existe', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            mockPrisma.invoiceRule.findUnique.mockResolvedValue(null);
            // Ejecutar método y verificar que lanza error
            yield expect(service.toggleRuleActive(999, true, 1)).rejects.toThrow('Regla con ID 999 no encontrada');
        }));
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para verificar existencia
            ...
            mockPrisma.invoiceRule.update.mockRejectedValue(mockError);
            // Ejecutar método y verificar que lanza error
            yield expect(service.toggleRuleActive(1, false, 1)).rejects.toThrow();
            // Verificar que se registró el error
            expect(ServerLogger.error).toHaveBeenCalledWith('Error al desactivar regla 1:', mockError);
        }));
    });
    describe('executeRule', () => {
        it('debe ejecutar una regla y generar facturas', () => __awaiter(void 0, void 0, void 0, function* () {
            // Datos de prueba
            const ruleId = 1;
            const userId = 1;
            ...
            // Configurar mock para actualización
            mockPrisma.invoiceRule.update.mockResolvedValue(Object.assign(Object.assign({}, mockRule), { lastRun: new Date() }));
            // Ejecutar método
            const result = yield service.executeRule(ruleId, userId);
            // Verificar resultado
        ...
        it('debe lanzar error si la regla está inactiva', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.executeRule(1, 1)).rejects.toThrow('No se puede ejecutar una regla inactiva');
        }));
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para obtener regla
            service.getRuleById = jest.fn().mockResolvedValue({
            ...
            // Ejecutar método y verificar que lanza error
            yield expect(service.executeRule(1, 1)).rejects.toThrow();
            // Verificar que se registró el error
    ...
    describe('processScheduledRules', () => {
        it('debe procesar todas las reglas programadas', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar método
            const result = yield service.processScheduledRules();
            // Verificar resultado
            expect(result).toEqual({
                rulesProcessed: 2,
                results: [
        ...
        it('debe manejar errores en reglas individuales', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para obtener reglas programadas
            const mockRules = [
                { id: 1, name: 'Regla 1', isActive: true, nextRun: new Date('2025-01-01') },
                { id: 2, name: 'Regla 2', isActive: true, nextRun: new Date('2025-01-02') }
        ...
        it('debe manejar errores generales correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para lanzar error
            const mockError = new Error('Error de base de datos');
            mockPrisma.invoiceRule.findMany.mockRejectedValue(mockError);
            // Ejecutar método y verificar que lanza error
            yield expect(service.processScheduledRules()).rejects.toThrow();
            // Verificar que se registró el error
