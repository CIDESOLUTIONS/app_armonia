...
describe('PQRNotificationService', () => {
    ...
    describe('notifyStatusChange', () => {
        it('debe enviar notificaciones cuando cambia el estado de un PQR', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para PQR
        ...
        it('no debe enviar notificaciones si están desactivadas', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para PQR
            prisma.pQR.findUnique.mockResolvedValue({
                id: 123,
                ticketNumber: 'PQR-20250602-001',
    ...
    describe('sendDueDateReminders', () => {
        it('debe enviar recordatorios para PQRs próximos a vencer', () => __awaiter(void 0, void 0, void 0, function* () {
            // Fecha actual
            const now = new Date();
    ...
    describe('sendSatisfactionSurvey', () => {
        it('debe enviar encuesta de satisfacción para PQR resuelto', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('no debe enviar encuesta si el PQR no está resuelto', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('no debe enviar encuesta si están desactivadas', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para PQR resuelto
            prisma.pQR.findUnique.mockResolvedValue({
                id: 123,
                ticketNumber: 'PQR-20250602-001',
    ...
    describe('getNotificationTemplate', () => {
        it('debe obtener plantilla personalizada de la base de datos', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const template = yield service.getNotificationTemplate(PQRStatus.IN_PROGRESS, PQRStatus.ASSIGNED);
            // Verificar resultado
        ...
        it('debe usar plantilla predeterminada cuando no hay personalizada', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para plantilla (vacío)
            prisma.$queryRaw.mockResolvedValueOnce([]);
            // Ejecutar el método para estado RESOLVED
            const template = yield service.getNotificationTemplate(PQRStatus.RESOLVED);
            // Verificar resultado
