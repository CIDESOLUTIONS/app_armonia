...
describe('PQRMetricsService', () => {
    ...
    describe('getSummaryMetrics', () => {
        it('debe generar métricas de resumen correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            const result = yield service.getSummaryMetrics();
            // Verificar resultado
        ...
        it('debe aplicar filtros correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield service.getSummaryMetrics(testFilter);
    ...
    describe('getCategoryDistribution', () => {
        it('debe calcular distribución por categoría correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            const result = yield service.getCategoryDistribution();
            // Verificar resultado
    ...
    describe('getSLAMetrics', () => {
        it('debe calcular métricas de SLA correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            const result = yield service.getSLAMetrics();
            // Verificar resultado
            expect(result).toEqual({
                compliantCount: 2,
                nonCompliantCount: 1,
        ...
        it('debe calcular SLA cuando no hay campo slaBreached', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('getTimeTrend', () => {
        it('debe generar tendencia temporal correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock para conteo de PQRs
            prisma.pQR.count.mockResolvedValue(5);
            // Mock para PQRs resueltos
            prisma.pQR.findMany.mockResolvedValue([]);
            // Ejecutar el método
            const result = yield service.getTimeTrend();
            // Verificar resultado
    ...
    describe('getTopAssignees', () => {
        it('debe obtener métricas de los principales asignados', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            const result = yield service.getTopAssignees();
            // Verificar resultado
    ...
    describe('getRecentActivity', () => {
        it('debe obtener actividad reciente correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            const result = yield service.getRecentActivity();
            // Verificar resultado
            expect(result).toHaveLength(2);
    ...
    describe('generateDashboardMetrics', () => {
        it('debe generar métricas completas para el dashboard', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            const result = yield service.generateDashboardMetrics();
            // Verificar resultado
            ...
            yield service.generateDashboardMetrics(testFilter);
        ...
        it('debe manejar errores correctamente', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Ejecutar el método
            yield expect(service.generateDashboardMetrics()).rejects.toThrow('Error de prueba');
        }));
    });
});
