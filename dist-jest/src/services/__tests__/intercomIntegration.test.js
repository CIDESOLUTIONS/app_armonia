...
describe('IntercomService - Pruebas de integración', () => {
    ...
    describe('Flujo completo de visita', () => {
        it('debe manejar el flujo completo desde registro hasta salida', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // 2. Registrar visita
            const visitResult = yield intercomService.registerVisit({
                name: 'Juan Pérez',
                identification: '1234567890',
                phone: '+573001234567',
                typeId: 1
            ...
            prisma.virtualIntercomNotification.findUnique = jest.fn().mockResolvedValue(Object.assign(Object.assign({}, mockNotification), { visit: mockVisit }));
            prisma.virtualIntercomNotification.update = jest.fn().mockResolvedValue(Object.assign(Object.assign({}, mockNotification), { status: NotificationStatus.RESPONDED, respondedAt: new Date(), response: 'Aprobado', responseType: ResponseType.APPROVE }));
            prisma.visit.update = jest.fn()
                .mockResolvedValueOnce(Object.assign(Object.assign({}, mockVisit), { status: VisitStatus.APPROVED, authorizedBy: 1 }))
                .mockResolvedValueOnce(Object.assign(Object.assign({}, mockVisit), { status: VisitStatus.IN_PROGRESS, entryTime: new Date(), authorizedBy: 1 }))
                .mockResolvedValueOnce(Object.assign(Object.assign({}, mockVisit), { status: VisitStatus.COMPLETED, entryTime: new Date(), exitTime: new Date(), authorizedBy: 1 }));
            // 4. Procesar webhook de aprobación
            const webhookResult = yield intercomService.processWebhook(NotificationChannel.WHATSAPP, mockWhatsAppPayload);
            ...
            // 5. Registrar entrada
            yield intercomService.registerEntry('visit-123');
            ...
            // 6. Registrar salida
            yield intercomService.registerExit('visit-123');
            ...
            prisma.visit.findMany = jest.fn().mockResolvedValue([
                Object.assign(Object.assign({}, mockVisit), { status: VisitStatus.COMPLETED, entryTime: new Date(), exitTime: new Date(), authorizedBy: 1, createdAt: new Date(), notifications: [mockNotification] })
            ]);
            prisma.visit.count = jest.fn().mockResolvedValue(1);
            // 8. Obtener historial de visitas
            const historyResult = yield intercomService.getVisitHistory(1, {
                page: 1,
                pageSize: 10
            });
    ...
    describe('Escenarios de error', () => {
        it('debe manejar errores en el registro de visita', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(intercomService.registerVisit({
                name: 'Juan Pérez',
                identification: '1234567890',
                phone: '+573001234567',
                typeId: 1
            }, 1, 'Entrega de paquete')).rejects.toThrow('Error de base de datos');
        }));
        it('debe manejar errores en la notificación a residentes', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mock para simular error
            prisma.visit.findUnique = jest.fn().mockRejectedValue(new Error('Error al buscar visita'));
            // Verificar que se captura la excepción
            yield expect(intercomService.notifyResidents('visit-123')).rejects.toThrow('Error al buscar visita');
        }));
        it('debe manejar errores en el procesamiento de webhooks', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            jest.spyOn(intercomService, 'adapters').mockReturnValue(new Map([
                [NotificationChannel.WHATSAPP, mockAdapter]
            ]));
            // Verificar que se maneja el error
            const result = yield intercomService.processWebhook(NotificationChannel.WHATSAPP, { body: 'test' });
    ...
    describe('Configuración y preferencias', () => {
        it('debe actualizar correctamente las preferencias de usuario', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mocks
            ...
            prisma.userIntercomPreference.create = jest.fn().mockResolvedValue(Object.assign({ id: 1, userId: 1 }, mockPreferences));
            ...
            expect(result).toEqual(Object.assign({ id: 1, userId: 1 }, mockPreferences));
        }));
        it('debe actualizar correctamente la configuración del sistema', () => __awaiter(void 0, void 0, void 0, function* () {
            // Configurar mocks
            const mockSettings = {
                whatsappEnabled: true,
                whatsappProvider: 'twilio',
            ...
            prisma.intercomSettings.create = jest.fn().mockResolvedValue(Object.assign({ id: 1 }, mockSettings));
