...
class PQRAssignmentServiceMock {
     ...
     */
    assignPQR(pqrId, category, subcategory, priority) {
     ...
     */
    findSpecialist(category, specialization, priority) {
        return __awaiter(this, void 0, void 0, function* () {
            // Simular tiempo de procesamiento
            yield new Promise(resolve => setTimeout(resolve, 10));
     ...
     */
    reassignPQR(pqrId, newTeamId, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            // Simular tiempo de procesamiento
            yield new Promise(resolve => setTimeout(resolve, 10));
     ...
     */
    checkEscalationNeeded(pqrId, currentStatus, daysOpen) {
        return __awaiter(this, void 0, void 0, function* () {
            // Simular tiempo de procesamiento
            yield new Promise(resolve => setTimeout(resolve, 10));
