 ...
 */
export function createPrismaModelMock(defaultData = {}) {
    return {
 ...
 */
export function createPrismaClientMock(defaultData = {}) {
    ...
    const mockClient = Object.assign(Object.assign({}, mockModels), { $connect: jest.fn().mockResolvedValue({}), $disconnect: jest.fn().mockResolvedValue({}), $transaction: jest.fn().mockImplementation((callback) => __awaiter(this, void 0, void 0, function* () {
            return yield callback(mockClient);
        })), $queryRaw: jest.fn().mockResolvedValue([]), $executeRaw: jest.fn().mockResolvedValue(0) });
    return mockClient;
}
