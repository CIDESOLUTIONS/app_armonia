...
export const useFinancialSummary = () => {
    ...
    const fetchSummary = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        setLoading(true);
        setError(null);
        try {
            const _response = yield fetch('/api/financial/summary');
            if (!response.ok)
    ...
    const fetchTrends = useCallback((...args_1) => __awaiter(void 0, [...args_1], void 0, function* (months = 12) {
        setLoading(true);
        try {
            const _response = yield fetch(`/api/financial/trends?months=${months}`);
            if (!response.ok)
    ...
    const generateProjections = useCallback((months = 6) => {
    ...
    const generateReport = useCallback((type) => __awaiter(void 0, void 0, void 0, function* () {
        setLoading(true);
        try {
            const _response = yield fetch(`/api/financial/reports?type=${type}`);
            if (!response.ok)
