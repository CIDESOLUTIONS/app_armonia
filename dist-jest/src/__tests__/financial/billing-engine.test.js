...
describe('BillingEngine', () => {
    ...
    describe('generateBillsForPeriod', () => {
        it('should generate bills for all active properties', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Execute
            const bills = yield BillingEngine.generateBillsForPeriod(1, period);
            // Assertions
        ...
        it('should throw error for complexes without billing access', () => __awaiter(void 0, void 0, void 0, function* () {
            const { getPrisma } = yield import('@/lib/prisma');
            const mockPrisma = getPrisma();
            const mockComplex = {
                id: 1,
            ...
            yield expect(BillingEngine.generateBillsForPeriod(1, period)).rejects.toThrow('Funcionalidad no disponible en su plan actual');
        }));
    });
    ...
    describe('processPayment', () => {
        it('should process full payment correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            const { getPrisma } = yield import('@/lib/prisma');
            const mockPrisma = getPrisma();
            const mockBill = {
                id: 1,
            ...
            const result = yield BillingEngine.processPayment(1, 100000, 'BANK_TRANSFER', 'REF123');
            expect(result).toBe(true); // Full payment
            expect(mockPrisma.$transaction).toHaveBeenCalled();
        }));
        it('should process partial payment correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            const { getPrisma } = yield import('@/lib/prisma');
            const mockPrisma = getPrisma();
            const mockBill = {
                id: 1,
            ...
            mockPrisma.bill.findUnique.mockResolvedValue(mockBill);
            const result = yield BillingEngine.processPayment(1, 50000, 'CREDIT_CARD');
            expect(result).toBe(false); // Partial payment
        }));
        it('should throw error for already paid bills', () => __awaiter(void 0, void 0, void 0, function* () {
            const { getPrisma } = yield import('@/lib/prisma');
            const mockPrisma = getPrisma();
            const mockBill = {
                id: 1,
            ...
            mockPrisma.bill.findUnique.mockResolvedValue(mockBill);
            yield expect(BillingEngine.processPayment(1, 100000, 'CASH')).rejects.toThrow('Factura ya está pagada');
        }));
    });
