...
const AssembliesLayout = ({ children }) => {
    ...
    return (_jsxs("div", { className: "flex flex-col md:flex-row", children: [_jsxs("aside", { className: "w-full md:w-64 shrink-0 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 mb-4 md:mb-0 md:mr-4", children: [_jsx("h2", { className: "text-lg font-semibold mb-4 text-gray-800 dark:text-gray-200", children: "Gesti\u00F3n de Asambleas" }), _jsx("nav", { children: _jsx("ul", { className: "space-y-2", children: menuItems.map((item) => (_jsx("li", { children: _jsxs(Link, { href: item.href, className: cn("flex items-center gap-2 px-3 py-2 rounded-md transition-colors", pathname === item.href
                                        ? "bg-indigo-50 text-indigo-600 dark:bg-indigo-900 dark:text-indigo-300"
                                        : "text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700"), children: [_jsx(item.icon, { className: "h-4 w-4" }), _jsx("span", { children: item.title }), _jsx(ChevronRight, { className: "h-4 w-4 ml-auto" })] }) }, item.href))) }) })] }), _jsx("main", { className: "flex-1 bg-white dark:bg-gray-800 rounded-lg shadow-sm", children: children })] }));
};
