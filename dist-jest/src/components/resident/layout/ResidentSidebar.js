...
import { ChevronLeft, Home, DollarSign, MessageSquare, Calendar, FileText, Bell, Settings, ClipboardList, Users, Car, PawPrint } from 'lucide-react';
...
export function ResidentSidebar({ collapsed, onToggle }) {
